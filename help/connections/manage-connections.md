...
>abstract="De gemiddelde hoeveelheid opslag die wordt verbruikt door elke rij gegevens die in Customer Journey Analytics (in kB) wordt ingevoerd en opgeslagen voor de huidige maand, met een procentuele wijziging in vergelijking met de voorgaande maand."


>[!CONTEXTUALHELP]
>id="connections_coredatavolume"
>title="Kerngegevensvolume"
>abstract="De totale hoeveelheid gegevens die op schijf is opgeslagen en die voor de huidige maand (in GB of TB) is voorzien van een tijdstempel, met een procentuele wijziging in vergelijking met de vorige maand."
