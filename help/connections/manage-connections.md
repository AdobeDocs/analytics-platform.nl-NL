...
1. Zoek de Journey Optimizer-verbinding die u met Customer Journey Analytics wilt gebruiken.
   ...
   1. Selecteer **[!UICONTROL Use in CJA]** in de sectie **[!UICONTROL Off]** .
      ...
      Hiermee worden alle verbindingen weergegeven die momenteel niet zijn geconfigureerd voor gebruik in Customer Journey Analytics.

   1. Selecteer de Journey Optimizer-verbinding die u in Customer Journey Analytics wilt gebruiken.

1. Selecteer **[!UICONTROL Use in CJA]** in de Journey Optimizer-verbinding.
...
1. Selecteer **[!UICONTROL Remove from CJA]** wanneer u een Journey Optimizer-verbinding bewerkt.
