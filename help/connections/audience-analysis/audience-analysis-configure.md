...
>abstract="Het beleid van de fusie combineert profielgegevens van veelvoudige datasets in verenigde klantenprofielen die voor publieksverwezenlijking worden gebruikt. Selecteer het Standaard op tijd gebaseerde samenvoegbeleid als er meerdere samenvoegbeleidsregels worden weergegeven en u niet zeker weet welke u moet kiezen. U kunt uw gegevensteam ook raadplegen om beter te begrijpen welk publiek met elk fusiebeleid wordt geassocieerd."
...
1. Geef de volgende informatie op om de verbinding te configureren:
   ...
   | Veld | Beschrijving |
   |---------|----------|
   | **[!UICONTROL Person ID]** | Selecteer een gebied van het op model-gebaseerde schema dat identiteitskaart van de Persoon vertegenwoordigt. De selectie is beperkt tot de lijst met velden in het op een model gebaseerde schema die zijn gemarkeerd als Identiteit en wel een naamruimte voor identiteit hebben.<p>Als er geen persoon-id&#39;s zijn waaruit u kunt kiezen, betekent dit dat een of meer personen-id&#39;s niet zijn gedefinieerd in het schema. Zie [&#x200B; identiteitsgebieden in UI &#x200B;](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/ui/fields/identity) voor meer informatie bepalen.</p> |
