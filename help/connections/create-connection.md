...
3. Nu, vorm de datasets één voor één.
   ...
   | **[!UICONTROL Import new data]** | Deze optie inschakelen [!UICONTROL On] als u een doorlopende verbinding wilt maken. Wanneer geselecteerd stromen om het even welke nieuwe gegevensbatches die aan de datasets in deze verbinding worden toegevoegd automatisch in Werkruimte. |
