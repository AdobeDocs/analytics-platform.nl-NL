...
>abstract="Customer Journey Analytics-gebruik kan leiden tot extra wijzigingen op basis van de volumes met integratiegegevens. Zie [&#x200B; details op het factureren van Customer Journey Analytics en gebruik &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)"
