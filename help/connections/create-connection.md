---
title: Een verbinding maken of bewerken
description: Leer hoe u een verbinding met een Experience Platform-gegevensset maakt of bewerkt in Customer Journey Analytics.
...
>title="Identiteitsinstellingen wijzigen "
>abstract="Een verandering van identiteit het plaatsen schrapt verbindingsgegevens voor deze dataset, zodra u de wijzigingen in de interface van Verbindingen opslaat. U zult een gegevensbackfill voor de dataset manueel moeten beginnen, die op de nieuwe montages wordt gebaseerd.<br/><br/> een vertraging in het melden is mogelijk tot het schrappingsproces wordt voltooid."

>[!CONTEXTUALHELP]
>id="connection_change_accountid"
>title="Account-id wijzigen"
>abstract="Als de account-id wordt gewijzigd, worden alle bestaande gegevens in de verbinding verwijderd en worden alle gegevens uit de gegevensset opnieuw ingevoerd op basis van de nieuwe account-id. Deze actie kan gevolgen hebben voor de kosten. <br/><br/> wanneer u **[!UICONTROL Continue]** selecteert, is een vertraging in rapportering mogelijk tot het proces voltooit."

>[!CONTEXTUALHELP]
>id="connection_change_globalaccountid"
>title="Globale account-id wijzigen"
>abstract="Als u de globale account-id wijzigt, worden alle bestaande gegevens in de verbinding verwijderd en worden alle gegevens opnieuw ingevoerd uit de gegevensset die is gebaseerd op de nieuwe algemene account-id. Deze actie kan gevolgen hebben voor de kosten. <br/><br/> wanneer u **[!UICONTROL Continue]** selecteert, is een vertraging in rapportering mogelijk tot het proces voltooit."

>[!CONTEXTUALHELP]
>id="connection_change_opportunityid"
>title="Opportunity-id wijzigen"
>abstract="Een verandering van identiteitskaart van de Kans schrapt alle bestaande gegevens in de verbinding en neemt alle gegevens van de dataset opnieuw op die op nieuwe identiteitskaart van de Kans wordt gebaseerd. Deze actie kan gevolgen hebben voor de kosten. <br/><br/> wanneer u **[!UICONTROL Continue]** selecteert, is een vertraging in rapportering mogelijk tot het proces voltooit."

>[!CONTEXTUALHELP]
>id="connection_change_buyinggroupid"
>title="Koopgroep-id wijzigen"
>abstract="Een verandering van het Kopen identiteitskaart van de Groep schrapt alle bestaande gegevens in de verbinding en neemt alle gegevens van de dataset opnieuw op die op nieuwe het Kopen identiteitskaart van de Groep wordt gebaseerd. Deze actie kan gevolgen hebben voor de kosten. <br/><br/> wanneer u **[!UICONTROL Continue]** selecteert, is een vertraging in rapportering mogelijk tot het proces voltooit."

>[!CONTEXTUALHELP]
>id="connection_change_persistentid"
>title="Blijvende id wijzigen"
>abstract="Als de id voor continue verbindingen wordt gewijzigd, worden alle bestaande gegevens in de verbinding verwijderd en worden alle gegevens opnieuw ingevoerd uit de gegevensset die is gebaseerd op de nieuwe id voor continue verbindingen. Deze actie kan gevolgen hebben voor de kosten. <br/><br/> wanneer u **[!UICONTROL Continue]** selecteert, is een vertraging in rapportering mogelijk tot het proces voltooit."


>[!CONTEXTUALHELP]
>id="connection_use_primary_identity_namespace"
>title="Primaire naamruimte gebruiken"
>abstract="Detecteer en gebruik automatisch een naamruimte identityMap die is gedefinieerd als **[!UICONTROL primary]** op elk gebeurtenisniveau."
>additional-url="https://experienceleague.adobe.com/nl/docs/experience-platform/identity/features/namespaces" text="Overzicht naamruimte identiteit"
...
>title="Deze verbinding gebruiken in Customer Journey Analytics"
>abstract="Met deze optie kunt u de geavanceerde rapportagemogelijkheden van Customer Journey Analytics benutten met uw Journey Optimizer-verbinding. Met deze mogelijkheden kunt u:<ul><li>Voer een diepgaande analyse uit van Journey Optimizer-gegevens in Customer Journey Analytics.</li><li>Bewerk de Journey Optimizer-verbinding en de bijbehorende gegevensweergaven.</li><li>Analyseer reisgebeurtenissen, gesprekspaden en campagneprestaties.</li></ul>**wanneer deze optie wordt toegelaten, telt elke rij gegevens binnen de verbinding aan uw vergunningsrijen van gegevens elke maand voor Customer Journey Analytics. En wordt weergegeven in de gebruikersinterface voor verbindingen.**<br><br/> verken deze optie slechts als u met het extra gebruik van rijen van gegevens in Customer Journey Analytics comfortabel bent. [Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/integrations/ajo){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_disableuseincja_exl_ajo"
>title="Deze verbinding verwijderen uit Customer Journey Analytics"
>abstract="Deze Journey Optimizer-verbinding wordt momenteel gebruikt in Customer Journey Analytics. Met de verbinding kunt u:<ul><li>Voer een diepgaande analyse uit van Journey Optimizer-gegevens in Customer Journey Analytics.</li><li>Bewerk de Journey Optimizer-verbinding en de bijbehorende gegevensweergaven.</li><li>Analyseer reisgebeurtenissen, gesprekspaden en campagneprestaties.</li></ul>**als u de verbinding verwijdert, is de diepgaande analyse in Customer Journey Analytics niet meer mogelijk. De verbinding en de bijbehorende gegevensweergaven worden teruggezet op hun standaardstatus en kunnen niet meer worden bewerkt.**<br/><br/>**het Factureren voor deze verbinding in Customer Journey Analytics omvat de volledige maand waarin de verbinding wordt verwijderd.**<br/><br/> de verbinding blijft toegelaten in Journey Optimizer. [Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/integrations/ajo){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_useincja_exl_brand_concierge"
>title="Deze verbinding gebruiken in Customer Journey Analytics"
>abstract="Met deze optie kunt u de geavanceerde rapportagemogelijkheden van Customer Journey Analytics benutten met uw Brand Concierge-verbinding. Met deze mogelijkheden kunt u:<ul><li>Voer een diepgaande analyse uit van Brand Concierge-gegevens in Customer Journey Analytics.</li><li>Bewerk de Brand Concierge-verbinding en de bijbehorende gegevensweergaven.</li><li>Analyseer conversatie-betrokkenheid, sentiment en conversiemetriek.</li></ul>**wanneer deze optie wordt toegelaten, telt elke rij gegevens binnen de verbinding aan uw vergunningsrijen van gegevens elke maand voor Customer Journey Analytics. En wordt weergegeven in de gebruikersinterface voor verbindingen.**<br><br/> verken deze optie slechts als u met het extra gebruik van rijen van gegevens in Customer Journey Analytics comfortabel bent. [Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-workspace/templates/use-templates#brand-concierge-templates){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_disableuseincja_exl_brand_concierge"
>title="Deze verbinding verwijderen uit Customer Journey Analytics"
>abstract="Deze Brand Concierge-verbinding wordt momenteel gebruikt in Customer Journey Analytics. Met de verbinding kunt u:<ul><li>Voer een diepgaande analyse uit van Brand Concierge-gegevens in Customer Journey Analytics.</li><li>Bewerk de Brand Concierge-verbinding en de bijbehorende gegevensweergaven.</li><li>Analyseer conversatie-betrokkenheid, sentiment en conversiemetriek.</li></ul>**als u de verbinding verwijdert, is de diepgaande analyse in Customer Journey Analytics niet meer mogelijk. De verbinding en de bijbehorende gegevensweergaven worden teruggezet op hun standaardstatus en kunnen niet meer worden bewerkt.**<br/><br/>**het Factureren voor deze verbinding in Customer Journey Analytics omvat de volledige maand waarin de verbinding wordt verwijderd.**<br/><br/> de verbinding blijft toegelaten in Brand Concierge. [Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-workspace/templates/use-templates#brand-concierge-templates){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_useincja_exl_product_usage"
>title="Deze verbinding gebruiken in Customer Journey Analytics"
>abstract="Met deze optie kunt u de geavanceerde rapportagemogelijkheden van Customer Journey Analytics benutten met uw verbinding voor productgebruik. Met deze mogelijkheden kunt u:<ul><li>Voer een diepgaande analyse uit van de productgebruiksgegevens in Customer Journey Analytics.</li><li>Bewerk de verbinding voor productgebruik en de bijbehorende gegevensweergaven.</li></ul>**wanneer deze optie wordt toegelaten, telt elke rij gegevens binnen de verbinding aan uw vergunningsrijen van gegevens elke maand voor Customer Journey Analytics. En wordt weergegeven in de gebruikersinterface voor verbindingen.**<br><br/> verken deze optie slechts als u met het extra gebruik van rijen van gegevens in Customer Journey Analytics comfortabel bent. [Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/tools/product-usage/usage-overview){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_disableuseincja_exl_product_usage"
>title="Deze verbinding verwijderen uit Customer Journey Analytics"
>abstract="Deze productgebruiksverbinding wordt momenteel gebruikt in Customer Journey Analytics. Met de verbinding kunt u:<ul><li>Voer een diepgaande analyse uit van de productgebruiksgegevens in Customer Journey Analytics.</li><li>Bewerk de verbinding voor productgebruik en de bijbehorende gegevensweergaven.</li></ul>**als u de verbinding verwijdert, is de diepgaande analyse in Customer Journey Analytics niet meer mogelijk. De verbinding en de bijbehorende gegevensweergaven worden teruggezet op hun standaardstatus en kunnen niet meer worden bewerkt.**<br/><br/>**het Factureren voor deze verbinding in Customer Journey Analytics omvat de volledige maand waarin de verbinding wordt verwijderd.**<br/><br/> de verbinding blijft toegelaten voor productgebruik. [Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/tools/product-usage/usage-overview){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_useincja_legal_section_section"
>title="Rechtsgevolgen"
>abstract="Het gebruik van Customer Journey Analytics kan leiden tot extra kosten op basis van de volumes met integratiegegevens. Zie [&#x200B; details op het factureren van Customer Journey Analytics en gebruik &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)"


>[!CONTEXTUALHELP]
>id="connections_useincja_exl_ajo_learn_more"
>title="Meer informatie"
>abstract="[Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)."

>[!CONTEXTUALHELP]
>id="connections_useincja_exl_brand_concierge_learn_more"
>title="Meer informatie"
>abstract="[Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-workspace/templates/use-templates#brand-concierge-templates)."

>[!CONTEXTUALHELP]
>id="connections_useincja_exl_product_usage_learn_more"
>title="Meer informatie"
>abstract="[Meer info](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/tools/product-usage/usage-overview)."
...
Zie ![&#x200B; VideoCheckedOut &#x200B;](/help/assets/icons/VideoCheckedOut.svg) [&#x200B; verbinden met gegevensbronnen &#x200B;](https://experienceleague.adobe.com/nl/docs/customer-journey-analytics-learn/tutorials/connections/connecting-customer-journey-analytics-to-data-sources-in-platform){target="_blank"} voor een demo video.
...
1. Configureer de verbindingsinstellingen.
   ...
   | **[!UICONTROL Schema]** | Het [&#x200B; die schema &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/xdm/schema/composition) wordt gebaseerd waarop de dataset in Adobe Experience Platform werd gecreeerd. |
   ...
   | **[!UICONTROL Stitched]** | Als een dataset [&#x200B; voor het stitching in de Verbinding UI &#x200B;](/help/stitching/use-stitching-ui.md) wordt toegelaten, is de waarde **[!UICONTROL true]**. Anders is de waarde **[!UICONTROL false]** . De gestaafde datasets die het resultaat van het [&#x200B; verzoek zijn om procedure &#x200B;](/help/stitching//use-stitching.md) te verbinden worden niet geïdentificeerd zoals vastgemaakt in deze lijst, en door gebrek hebben een waarde van **[!UICONTROL false]**. |
...
1. Configureer de verbindingsinstellingen.
   ...
   | **[!UICONTROL Number of records]** | The total records in the previous month for the dataset in Experience Platform. |
   | **[!UICONTROL Schema]** | Het [&#x200B; die schema &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/xdm/schema/composition) wordt gebaseerd waarop de dataset in Adobe Experience Platform werd gecreeerd. |
   | **[!UICONTROL Dataset type]** | Voor elke dataset die u aan deze verbinding toevoegde, plaatst Customer Journey Analytics automatisch het [&#x200B; datasettype &#x200B;](#dataset-types) dat op de gegevens wordt gebaseerd die binnen komen. |
   | **[!UICONTROL Granularity]** | De granulariteit van de gegevens in de gegevensset; alleen van toepassing voor samenvattende gegevenssets. |
   | **[!UICONTROL Data source type]** | Het gegevensbrontype van de dataset. Niet van toepassing voor samenvattende gegevensreeksen. |
...
>[!NOTE]
>
>Waarden vóór het jaar 1900 voor datum- en datum-tijdvelden in een rij in elk type gegevensset worden vervangen door de waarde `null` voordat de rij wordt ingevoegd.<br/> de Rijen in een gebeurtenis of een summiere dataset met een timestamp waarde vóór het jaar 1900 worden gelaten vallen van opname.
...
>title="Persoon-id"
>abstract="Selecteer een persoon-id (de unieke id voor een persoon) uit de beschikbare identiteiten die u in het gegevenssetschema in de Experience Platform hebt gedefinieerd."

>[!CONTEXTUALHELP]
>id="cja_connection_matchingkey"
>title="Overeenkomende toets"
>abstract="Selecteer een veld om aan te sluiten bij een van de gebeurtenisgegevenssets. Als deze lijst leeg is, hebt u waarschijnlijk geen gebeurtenisdataset toegevoegd of gevormd."
...
>title="Identiteitsstitatie inschakelen"
>abstract="Schakel identiteitsstitching in om deze gebeurtenisdataset voor kanaalanalyse op te heffen."
>additional-url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/stitching/overview" text="Overzicht van tekenreeksen"

>[!CONTEXTUALHELP]
>id="connection_stitching_dialog"
>title="Identiteitsstitatie"
>abstract="Identiteitstitching leidt de informatie van de gebruikersidentiteit uit een dataset of uit de identiteitsgrafiek af. Dit proces kan het samenvoegen van gebruikersgegevens van geverifieerde en niet-geverifieerde sessies omvatten.<br/><br/> u bent verantwoordelijk om met toepasselijke wetten en verordeningen te voldoen. Deze naleving omvat dat u de noodzakelijke eind - gebruikerstoestemmingen verkrijgt alvorens u het stitching op een dataset activeert."
>additional-url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/stitching/overview" text="Overzicht van tekenreeksen"

>[!CONTEXTUALHELP]
>id="connection_persistentid"
>title="Blijvende id"
>abstract="Selecteer een permanente id uit de beschikbare identiteiten. Een blijvende id is een id die beschikbaar is voor alle gebeurtenissen in de gebeurtenisdataset."
>additional-url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/stitching/overview" text="Overzicht van tekenreeksen"

>[!CONTEXTUALHELP]
>id="connection_lookbackwindow"
>title="Venster opnieuw afspelen"
>abstract="Selecteer de geschikte tijdsperiode voor het afspeelvenster om in stitching te gebruiken."
>additional-url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/stitching/overview" text="Overzicht van tekenreeksen"

>[!CONTEXTUALHELP]
>id="connection_namespace_map"
>title="Identiteitskaart van naamruimte"
>abstract="Selecteer de naamruimte die u wilt gebruiken om de id in het identiteitsoverzicht te selecteren."
>additional-url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/stitching/overview" text="Overzicht van tekenreeksen"

>[!CONTEXTUALHELP]
>id="connection_namespace_graph"
>title="Identiteitsgrafiek naamruimte"
>abstract="Selecteer de naamruimte die u wilt gebruiken om de id in de identiteitsgrafiek te kiezen."
>additional-url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/stitching/overview" text="Overzicht van tekenreeksen"
...
Alternatief, kunnen de hierboven vermelde datasettypes op een ad hoc of relationeel schema in plaats van een generisch op XDM-Gebaseerd schema worden gebaseerd.

| Het type DataSet | Beschrijving | Tijdstempel | Schema | Persoon-id |
|---|---|---|---|---|
| **[!UICONTROL Adhoc]** | Ad hoc gegevens die op een [&#x200B; ad hoc schema &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/xdm/api/ad-hoc) met gebieden worden gebaseerd die namespaced voor gebruik slechts door één enkele dataset. | Afhankelijk van het type gegevensset dat u selecteert voor de ad-hocgegevensset. | Om het even welk ad hoc schema dat op een klasse gebaseerd is die op het *ad hoc* gedrag wordt gebaseerd | Afhankelijk van het type gegevensset dat u selecteert voor de ad-hocgegevensset. |
| **[!UICONTROL Model]** | Relationele gegevens die op een relationeel schema worden gebaseerd. | Afhankelijk van het gegevenstype dat u selecteert voor de relationele dataset. | Een relationeel schema. | Afhankelijk van het gegevenstype dat u selecteert voor de relationele dataset. |
...
#### Voor op persoon-gebaseerde verbindingen
...
1. In de stap ➊ **[!UICONTROL Select datasets]** ziet u een lijst met Experience Platform-gegevenssets.
   ...
   | **[!UICONTROL Dataset type]** | Het type van dataset: [&#x200B; Gebeurtenis &#x200B;](#event-dataset), [&#x200B; Profiel &#x200B;](#profile-dataset), [&#x200B; Opzoeken &#x200B;](#lookup-dataset), [&#x200B; Samenvatting &#x200B;](#summary-dataset), [&#x200B; Adhoc &#x200B;](#ad-hoc-dataset), of [&#x200B; Relationeel &#x200B;](#relational-dataset). |
   | **[!UICONTROL Number of records]** | The total records in the previous month for the dataset in Experience Platform. |
   | **[!UICONTROL Schema]** | Het schema voor de dataset. Selecteer de naam om u naar het schema in Experience Platform te leiden. |
   | **[!UICONTROL Last batch]** | De status van de laatste partij die in Experience Platform is ingenomen. Zie [&#x200B; de staten van de Partij &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/ingestion/batch/troubleshooting#batch-states) meer informatie. |
   ...
   * Om naar een specifieke dataset te zoeken, gebruik het ![&#x200B; onderzoeksgebied van het 1&rbrace; Onderzoek &#x200B;](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Search_18_N.svg).
...
1. Vorm de [&#x200B; montages voor elk van de geselecteerde datasets &#x200B;](#dataset-settings), één voor één, in de ➋ **[!UICONTROL Datasets settings]** stap van de **[!UICONTROL Add datasets]** dialoog.
   ...
   * Om een dataset uit de verbinding te verwijderen, selecteer ![&#x200B; RemoveCircle &#x200B;](/help/assets/icons/RemoveCircle.svg) **[!UICONTROL Remove]**.
   * Selecteer **[!UICONTROL Back]** als u een stap terug wilt uitvoeren.
   * Selecteer **[!UICONTROL Cancel]** als u het toevoegen van gegevenssets aan een verbinding wilt annuleren.

1. U moet alle vereiste montages voor de geselecteerde datasets specificeren alvorens u kunt verdergaan. Als de vereiste invoer ontbreekt, ziet u een rood getal dat aangeeft hoeveel datasets van een bepaald type die vereiste invoer niet bevatten. A ![&#x200B; AlertRed &#x200B;](/help/assets/icons/AlertRed.svg) en een verklaring in rood identificeert vereiste gebieden die geen input of een geselecteerde waarde hebben. Als u alle vereiste instellingen voor alle gegevenssets hebt geconfigureerd, selecteert u **[!UICONTROL Next]** .
1. In ❸ **[!UICONTROL Datasets preview]** ziet u een voorvertoning voor elke dataset die is gebaseerd op een eenvoudige set gegevens uit onlangs opgenomen gegevens.

   ![&#x200B; Voorproef van een dataset terwijl het toevoegen van datasets als deel van een verbinding &#x200B;](/help/connections/assets/add-dataset-preview.png)

   * Schakel **[!UICONTROL Show column namespace]** in als u naamruimten voor elk van de kolommen in de tabel wilt weergeven.
   * Om in de steekproefgegevens te zoeken, gebruik ![&#x200B; Onderzoek &#x200B;](/help/assets/icons/Search.svg).
   * Om te vormen welke kolommen te tonen, selecteer ![&#x200B; ColumnSetting &#x200B;](/help/assets/icons/ColumnSetting.svg). <br/> in het **[!UICONTROL Customize table]** dialoogvenster:
      1. Selecteer de kolommen die u in de tabel wilt weergeven.
      1. Selecteer **[!UICONTROL Apply]** om de selectie toe te passen of **[!UICONTROL Cancel]** om de selectie te annuleren.
   * Selecteer **[!UICONTROL Values]** als u de gegevens voor kolommen met array- of objectgegevens wilt weergeven.

   In het deelvenster **[!UICONTROL Dataset info]** worden details over de gegevensset weergegeven. Selecteer de waarde voor **[!UICONTROL Schema]** of **[!UICONTROL Dataset]** om de relevante interface in Experience Platform te openen op een nieuw browsertabblad.
...
1. Selecteer **[!UICONTROL Add datasets]** om de gevormde datasets aan de verbinding toe te voegen.

>[!NOTE]
>Voor klanten die Customer Journey Analytics op AWS hebben geïmplementeerd, is er geen aparte ❸ stap voor de voorvertoning van gegevenssets. De voorvertoning maakt deel uit van de ❷ Dataset-instellingen.
>




#### Voor op account gebaseerde verbindingen
...
1. Vorm de [&#x200B; montages voor elk van de geselecteerde datasets &#x200B;](#dataset-settings), één voor één, in de ➋ **[!UICONTROL Datasets settings]** stap van de **[!UICONTROL Add datasets]** dialoog.
   ...
   ![&#x200B; voeg datasets &#x200B;](assets/add-dataset-b2b.png) toe
...
1. Selecteer ![&#x200B; uitgeven &#x200B;](/help/assets/icons/Edit.svg) **[!UICONTROL Edit connection]**.
...
1. In ❶ **[!UICONTROL Dataset settings]**, vorm de [&#x200B; datasetmontages &#x200B;](#dataset-settings) in de **[!UICONTROL Edit dataset: _naam van de Dataset_]** dialoog.

   ![&#x200B; geef dataset &#x200B;](assets/edit-dataset-b2c.png) uit

   Als u veranderingen aanbrengt, zorg ervoor u alle vereiste montages voor de dataset specificeert alvorens u verdergaat. Als de vereiste invoer ontbreekt, kunt u niet doorgaan. A ![&#x200B; AlertRed &#x200B;](/help/assets/icons/AlertRed.svg) en een verklaring in rood identificeert vereiste gebieden die geen input of een geselecteerde waarde hebben.

   >[!NOTE]
   >
   >U kunt niet **[!UICONTROL Dataset type]** uitgeven, **[!UICONTROL Person ID]**, **[!UICONTROL Identity namespace]** en **[!UICONTROL Timestamp]** voor een [&#x200B; ad hoc &#x200B;](#ad-hoc-dataset) of a [&#x200B; relationele &#x200B;](#relational-dataset) dataset die deel van een bewaarde verbinding uitmaakt. U wijzigt de volgende instellingen als volgt:
   >
   >1. Verwijder de bestaande ad-hocgegevensset of relationele gegevensset uit de verbinding.
   >1. Voeg de zelfde dataset met bijgewerkte montages aan de verbinding toe.
   >

   Om de dataset uit de verbinding te verwijderen, selecteer ![&#x200B; RemoveCircle &#x200B;](/help/assets/icons/RemoveCircle.svg) **[!UICONTROL Remove]**.

   Nadat u alle vereiste instellingen voor de gegevensset hebt geconfigureerd, selecteert u **[!UICONTROL Next]** .
...
1. Vorm de [&#x200B; montages van de dataset &#x200B;](#dataset-settings) in de **[!UICONTROL Edit dataset: _naam van de Dataset_]** dialoog.
   ...
   ![&#x200B; geef dataset &#x200B;](assets/edit-dataset-b2b.png) uit
...
| Instelling | Beschrijving |
| --- | --- |
| **[!UICONTROL Global Account ID]** | Selecteer een algemene account-id (de unieke id voor een account) uit de beschikbare identiteiten die zijn gedefinieerd in het gegevenssetschema in de Experience Platform. Dit is van toepassing wanneer u Global Account als container hebt toegevoegd aan uw verbinding. <p>Als een record geen waarde bevat voor de identiteit die u hebt geselecteerd als de account-id voor de gebeurtenisdataset, wordt de record overgeslagen. |
| **[!UICONTROL Account ID]** | Selecteer een account-id (de unieke id voor een account) uit de beschikbare identiteiten die zijn gedefinieerd in het gegevenssetschema in de Experience Platform. Dit is van toepassing wanneer u Global Account niet als container hebt toegevoegd aan uw verbinding. |
...
>[!NOTE]
>
>Hoewel mogelijk om te vormen en te selecteren, om prestatiesredenen zou u moeten vermijden om een ad hoc dataset voor tijdreeksgegevens (gebeurtenis, samenvatting) te gebruiken. Relationele of generische op XDM gebaseerde datasets zijn veel geschikter voor tijdreeksgegevens dan ad hoc datasets.

De specifieke montages voor een ad hoc dataset zijn:

| Instelling | Geselecteerd gegevenstype | Beschrijving |
|---|---|---|
| **[!UICONTROL Dataset type]** | N.v.t. | Het type gegevens in de ad-hocgegevensset. Mogelijke waarden zijn: **[!UICONTROL Event]** , **[!UICONTROL Profile]** , **[!UICONTROL Lookup]** en **[!UICONTROL Summary]** . |
| **[!UICONTROL Person ID]** | Gebeurtenis, profiel | Selecteer een veld in het ad-hocschema of relationeel schema dat de persoon-id vertegenwoordigt. Dit veld kan elk veld in de gegevensset zijn. Selecteer uit **[!UICONTROL Identity namespace fields]** of van **[!UICONTROL Non-identity fields]**. <br/> U kunt slechts een herkenningsteken van **[!UICONTROL Identity namespace]** selecteren als één of meerdere gebieden in het ad hoc schema als identiteit worden geëtiketteerd en een identiteitsnamespace hebben. |
| **[!UICONTROL Identity namespace]** | Gebeurtenis | Selecteer een naamruimte voor identiteiten als u een id voor personen hebt geselecteerd in **[!UICONTROL Non-identity]** -velden. |
| **[!UICONTROL Timestamp]** | Gebeurtenis, overzicht | Selecteer een veld in het ad-hocschema dat het tijdstempelveld vertegenwoordigt. Dit veld kan elk beschikbaar veld van het type `DateTime` zijn. |
| **[!UICONTROL Key]** | Opzoeken | De sleutel aan gebruik voor een dataset van de Opzoeken.<br/> als een verslag geen waarde voor de sleutel bevat u voor de raadplegingsdataset hebt geselecteerd, wordt het verslag overgeslagen. |
| **[!UICONTROL Matching key]** | Opzoeken | De passende sleutel om zich aan te sluiten in één van de gebeurtenis of raadplegingsdatasets. Als deze lijst leeg is, hebt u waarschijnlijk geen gebeurtenis of raadplegingsdataset toegevoegd of gevormd. |


#### Relationele gegevensset

>[!NOTE]
>
>Relationele gegevenssets worden voornamelijk gebruikt om de komende Experience Platform Data Mirror for Customer Journey Analytics-capaciteit te ondersteunen.
>

De specifieke montages voor een relationele dataset zijn:

| Instelling | Geselecteerd gegevenstype | Beschrijving |
|---|---|---|
| **[!UICONTROL Dataset type]** | N.v.t. | Het type gegevens in de relationele dataset.<br/> als de dataset tijd-reeksgegevens bevat, zijn de mogelijke waarden: **[!UICONTROL Event]** en **[!UICONTROL Summary]**. <br/> als de dataset verslaggegevens bevat, zijn de mogelijke waarden: **[!UICONTROL Profile]** en **[!UICONTROL Lookup]**. |
| **[!UICONTROL Person ID]** | Gebeurtenis, profiel | Selecteer een veld in het relationele schema dat de persoon-id vertegenwoordigt. De selectie is beperkt tot de lijst met velden in het relationele schema die zijn gemarkeerd als Identiteit en wel een naamruimte voor identiteit hebben. |
| **[!UICONTROL Timestamp]** | Gebeurtenis, overzicht | Het veld dat wordt gedefinieerd als de tijdstempeldescriptor in het schema. Dit veld wordt automatisch ingevuld. |
| **[!UICONTROL Key]** | Opzoeken | De sleutel aan gebruik voor een dataset van de Opzoeken.<br/> als een verslag geen waarde voor de sleutel bevat u voor de raadplegingsdataset hebt geselecteerd, wordt het verslag overgeslagen. |
| **[!UICONTROL Matching key]** | Opzoeken | De passende sleutel om zich aan te sluiten in één van de gebeurtenisdatasets. Als deze lijst leeg is, hebt u waarschijnlijk geen gebeurtenis of raadplegingsdataset toegevoegd of gevormd. |
...
Soms moet u gegevens uit een of meer gegevenssets opnieuw invoeren in een verbinding. Voor ad hoc of relationele dataset moet u [&#x200B; schrappen en dan de dataset opnieuw toevoegen &#x200B;](#edit-a-dataset). Voor andere datasets, kunt u montages bijwerken. Daartoe:

1. Voor de dataset wilt u gegevens voor opnieuw opnemen:
...
Om de verbinding voor te vertonen die u hebt gemaakt, selecteert u ![&#x200B; PageSearch &#x200B;](/help/assets/icons/PageSearch.svg) in het dialoogvenster Verbindingsinstellingen.**[!UICONTROL Connection preview]**
...
Met deze kaart krijgt u een beter inzicht in de manier waarop u uw verbinding hebt gedefinieerd. En hoe u opstelling het verband tussen uw gebeurtenis, profiel, raadpleging, en summiere datasets, gebruikend containers en herkenningstekens hebt.
...
De Kaart van de Identiteit is beschikbaar voor om het even welke dataset die een schema gebruikt dat op de [&#x200B; wordt gebaseerd ExperienceEvent XDM &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/xdm/home) klasse. Wanneer u een dergelijke dataset selecteert die in een Verbinding van Customer Journey Analytics moet worden omvat, hebt u de optie om of een gebied als primaire identiteitskaart of de Kaart van de Identiteit te selecteren:
...
|---|---|---|---|---|---|
| **[!UICONTROL Use primary identity namespace]gecontroleerd**<br/>![&#x200B; Gebruik primaire identiteitskaart namespace &#x200B;](assets/use-primary-identity-namespace.png) | Customer Journey Analytics laat de rij vallen. | Customer Journey Analytics laat de rij vallen, omdat er geen primaire id is opgegeven. | Alle id&#39;s die als primair zijn gemarkeerd, worden onder alle naamruimten geëxtraheerd naar een lijst. Vervolgens worden ze alfabetisch gesorteerd. Bij de nieuwe sortering wordt de eerste naamruimte met de eerste id gebruikt als de Person-id. | Eén id wordt gebruikt als de persoon-id. | Hoewel de naamruimte ongeldig kan zijn (niet aanwezig in Adobe Experience Platform), gebruikt Customer Journey Analytics de primaire id onder die naamruimte als de Person-id. |
| **[!UICONTROL Specific Identity Map namespace]geselecteerd**<br/>![&#x200B; gebruikt geen primaire identiteit namespace &#x200B;](assets/not-use-primary-identity-namespace.png) | Customer Journey Analytics laat de rij vallen. | Alle id&#39;s onder de geselecteerde naamruimte worden geëxtraheerd naar een lijst en de eerste id wordt gebruikt als de Person-id. | Alle id&#39;s onder de geselecteerde naamruimte worden geëxtraheerd naar een lijst en de eerste id wordt gebruikt als de Person-id. | Alle id&#39;s onder de geselecteerde naamruimte worden geëxtraheerd naar een lijst en de eerste id wordt gebruikt als de Person-id. | Alle id&#39;s onder de geselecteerde naamruimte worden geëxtraheerd naar een lijst en de eerste id wordt gebruikt als de Person-id. (Alleen een geldige naamruimte kan tijdens het maken van de verbinding worden geselecteerd, zodat een ongeldige naamruimte/id niet kan worden gebruikt als Person-id.) |
...
1. Ga naar [&#x200B; de Diensten van de Vraag van Adobe Experience Platform &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/query/home) en creeer een vraag.
...
>* Blog: [&#x200B; hoe te Gebeurtenis, Opzoeken, en de Datasets van het Profiel in Adobe Customer Journey Analytics &#x200B;](https://experienceleaguecommunities.adobe.com/adobe-analytics-3/how-to-leverage-event-lookup-and-profile-datasets-in-adobe-customer-journey-analytics-12699?profile.language=nl) gebruiken
