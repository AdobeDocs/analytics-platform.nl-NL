...
Zie ![ VideoCheckedOut ](/help/assets/icons/VideoCheckedOut.svg) [ stafmedewerkers bijstaan om tot mobiele scorecards ](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/dashboards/assist-executives-to-access-mobile-scorecards){target="_blank"} voor een demo video toegang te hebben.
