...
*Dit artikel documenteert de visualisatie van de Lijn in **Customer Journey Analytics**.<br/> zie [ Lijn ](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/line) voor de **Adobe Analytics**versie van dit artikel.*
