...
De rijinstellingen variëren afhankelijk van de component die u naar de tabel hebt gesleept. Om tot de montages van de lijstrij toegang te hebben, selecteer ![ Plaatsend ](/help/assets/icons/Setting.svg) naast een afmeting, segment, metrisch, tijdspanne, of een verdeling binnen elk van deze voorwerpen.**[!UICONTROL Settings]**
...
Zie ![ ](/help/assets/icons/VideoCheckedOut.svg) Rij en kolommontages 0} VideoCheckedOut in een Vrije vormlijst [ voor een demo video.](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/row-and-column-settings-in-freeform-tables){target="_blank"}
