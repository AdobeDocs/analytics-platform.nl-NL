...
| --- | --- |
| **[!UICONTROL Breakdown by position]** | Deze instelling is standaard uitgeschakeld en de onderverdelingen zijn gekoppeld aan statische rijitems. Stel je bijvoorbeeld voor dat je de top 3 paginadimensie-items (startpagina, zoekresultaten, afrekenen) uitsplitst per marketingkanaal. Daarna verlaat je het project en kom je twee weken later terug. Bij het opnieuw openen van het project zijn de bovenste 3 pagina&#39;s gewijzigd, en nu zijn Homepage, Zoekresultaten en Checkout in plaats daarvan de top 4-6 pagina&#39;s. Standaard worden de uitsplitsingen van je marketingkanalen nog steeds weergegeven onder Startpagina, Zoekresultaten en Afrekenen, ook al staan ze nu in de rijen 4-6. <br>Uitsplitsing naar positie **daarentegen** splitst altijd de top 3 items op, ongeacht wat ze zijn. Om terug te komen op het voorbeeld: wanneer u uw project opnieuw opent, worden de uitsplitsingen van het marketingkanaal gekoppeld aan de bovenste 3 pagina&#39;s in de tabel. En niet naar Homepage, zoekresultaten en afhandeling, die nu in de rijen 4 tot en met 6 staan. |
...
Het aantal rijen dat wordt weergegeven wijzigen:
...
| **[!UICONTROL Download selection as CSV]** | Download de dimensie-items van de visualisatie onmiddellijk naar uw lokale apparaat. |
| **[!UICONTROL Create hyperlink for all dimension items]** | Maak hyperlinks voor alle dimensie-items. Zie [Hyperlinks voor dimensies in een vrije-vormtabel](../freeform-table-hyperlinks.md) |
...
| **[!UICONTROL Display only selected rows]** | Geef alleen de geselecteerde items in de visualisatie weer. |
| **[!UICONTROL Create annotation from selection]** | Open de **[!UICONTROL Annotation details]** om een annotatie toe te voegen. |


De volgende aanvullende contextmenuopties zijn beschikbaar wanneer u een of meer dimensie-items (eerste kolom) of een of meer afzonderlijke cellen in de vrije-vormtabel selecteert.
...
| **[!UICONTROL Breakdown]** | Splits het dimensie-item op. Maak een keuze uit de lijst met **[!UICONTROL Dimensions]**, **[!UICONTROL Metrics]**, **[!UICONTROL Filters]** of **[!UICONTROL Date ranges]**. Alternatief zoeken naar een component, met behulp van *Zoeken*. |
...
| **[!UICONTROL Create audience from selection]** | Open het **[!UICONTROL Create audience]** dialoogvenster om een publiek op te bouwen op basis van de selectie. |

De volgende aanvullende contextmenuopties zijn beschikbaar bij het selecteren van een kolomkop met metrische gegevens.
...
| **[!UICONTROL Compare time periods]** | Hiermee voegt u de kolommen voor de tijdsperiode toe. Alleen beschikbaar als de dimensie niet op tijd is gebaseerd. U wordt aangeboden verscheidene opties bepaalt de *datumwaaier*: <li>**[!UICONTROL Prior *datumwaaier *aan deze datumwaaier]**</li><li>**[!UICONTROL Custom date range to this date range]**. Hiermee opent u de **[!UICONTROL Date range builder]** om het datumbereik op te geven.</li>Zie [Datumvergelijking](/help/components/date-ranges/time-comparison.md) voor meer informatie. |
