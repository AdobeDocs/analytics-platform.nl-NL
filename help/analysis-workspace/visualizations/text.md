...
Om user-defined rijke tekst aan uw project van Workspace toe te voegen, kunt u a ![&#x200B; &#x200B;](/help/assets/icons/Text.svg) visualisatie gebruiken van de Tekst **[!UICONTROL Text]** &lbrace;voor een visualisatie en een paneel.

>[!BEGINSHADEBOX]

Zie ![&#x200B; VideoCheckedOut &#x200B;](/help/assets/icons/VideoCheckedOut.svg) [&#x200B; visualisatie van de Tekst &#x200B;](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/add-text-visualizations){target="_blank"} voor een demo video.
