...
*Dit artikel documenteert de visualisatie van de Tekst in **Customer Journey Analytics**.<br/> zie [ Tekst ](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/text) voor de **Adobe Analytics**versie van dit artikel.*
