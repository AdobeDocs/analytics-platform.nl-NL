...
1. In de [Filter Builder](/help/components/filters/manage-filters.md), bewerkt u het filter en klikt u op **[!UICONTROL Save]**.
   ...
   Het opgeslagen filter is beschikbaar voor gebruik in het dialoogvenster [!UICONTROL Filter] in [!UICONTROL Analysis Workspace].
...
Net als andere visualisaties in Analysis Workspace kunt u een cohortvisualisatie downloaden als een CSV- of PDF-bestand. Zie voor meer informatie [PDF- of CSV-bestanden downloaden](/help/analysis-workspace/curate-share/download-send.md).