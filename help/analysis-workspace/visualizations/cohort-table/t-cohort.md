...
1. In de [ bouwer van de Filter ](/help/components/filters/filter-builder.md), geef verder het segment uit, dan klik **[!UICONTROL Save]**.

   Het opgeslagen segment is beschikbaar voor gebruik in het deelvenster [!UICONTROL Filter] in [!UICONTROL Analysis Workspace] .
