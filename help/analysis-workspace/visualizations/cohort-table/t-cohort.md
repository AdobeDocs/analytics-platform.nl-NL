...
1. Bewerk in [Filter Builder](https://docs.adobe.com/content/help/en/analytics/components/segmentation/segmentation-workflow/seg-build.html) het segment verder en klik vervolgens op **[!UICONTROL Save]**.
