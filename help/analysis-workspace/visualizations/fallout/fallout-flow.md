...
Zie ![&#x200B; VideoCheckedOut &#x200B;](/help/assets/icons/VideoCheckedOut.svg) [&#x200B; een rapport van de fallout visualisatie &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics-learn/tutorials/analysis-workspace/analyzing-customer-journeys/fallout-visualization){target="_blank"} voor een demo video creëren.
...
* Sleep (en rangschik) funnel-stappen (aanraakpunten).
...
Zowel zijn de Uitval als [&#x200B; visualisaties van het canvas van 0&rbrace; de Reis nuttig om te analyseren:](/help/analysis-workspace/visualizations/journey-canvas/journey-canvas.md)
