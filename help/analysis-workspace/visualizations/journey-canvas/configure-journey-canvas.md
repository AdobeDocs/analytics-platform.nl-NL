...
1. Vorm om het even welke volgende montages die over de bovenkant van visualisatie worden getoond:
   ...
   | Instelling | Functie |
   |---------|----------|
   | [!UICONTROL **Type van Knoop**] | Staat u toe om te vormen welke knooptypes in visualisatie worden getoond.<p>Als u een knooppunttype wilt verbergen in de visualisatie, selecteert u de (x) naast het knooppunttype of heft u de selectie van dit type op in het keuzemenu. Als u een verborgen knooppunttype wilt weergeven, selecteert u dit in het keuzemenu. (Knooppunten worden niet van de reis geschrapt wanneer u hen verbergt. Voor informatie over hoe te om een knoop te schrappen, zie [ knopen ](#delete-nodes) schrappen.)</p><p>De knooppunttypes die op dit gebied beschikbaar zijn hangen van de volgende factoren af:</p><ul><li>**voor reizen die in het canvas van de Reis** voortkwamen, zijn de volgende knooptypes beschikbaar:<ul><li>Dimension</li><li>Metrisch</li><li>Filter</li><li>Datumbereik</li></ul></li><li>**voor reizen die in Journey Optimizer voortkwamen en die beduidend in het canvas van de Reizen** zijn gewijzigd, zijn de volgende knooptypes beschikbaar: (De significante wijzigingen omvatten het toevoegen van of het verwijderen van knopen, het toevoegen van of het verwijderen van pijlen, of het veranderen van de componenten van een knoop.)<ul><li>Dimension</li><li>Metrisch</li><li>Filter</li><li>Datumbereik</li><li>Journey Optimizer-knooppunttypen, zoals Leessegment, Einde enzovoort</li></ul></li><li>**voor reizen die in Journey Optimizer voortkwamen en die niet beduidend in het canvas van de Reizen** zijn gewijzigd, zijn de volgende knooptypes beschikbaar: (De significante wijzigingen omvatten het toevoegen van of het verwijderen van knopen, het toevoegen van of het verwijderen van pijlen, of het veranderen van de componenten van een knoop.)<ul><li>Journey Optimizer-knooppunttypen, zoals Leessegment, Einde enzovoort</li></ul></li></ul> |
...
| Item Dimension + item Dimension (vanuit dezelfde bovenliggende dimensie) | Samengevoegd met OR |
| Item Dimension + item Dimension (van verschillende bovenliggende afmetingen) | Deelnemen met AND |
