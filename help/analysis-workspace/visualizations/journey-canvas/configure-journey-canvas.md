...
1. Geef de volgende basisinformatie op om het canvas Reis te configureren:
   ...
   | [!UICONTROL **reis van Journey Optimizer**]<!-- name? --> | Selecteer de reis van Journey Optimizer die u als basis voor uw analyse in het canvas van de Reis wilt gebruiken. Er zijn reizen met een van de volgende statussen beschikbaar: Live, Gestopt of Voltooid <p>U kunt deze optie ook leeg laten als u een leeg canvas wilt maken waaruit u de analyse in Analysis Workspace wilt opbouwen.</p> <p>Wanneer u een reis van Journey Optimizer analyseert in het reiscanvas, wordt de reis weergegeven in dezelfde volgorde, volgorde en structuur als in Journey Optimizer. Zie [Journey Optimizer-reizen](/help/analysis-workspace/visualizations/journey-canvas/journey-canvas.md#analyze-journey-optimizer-journeys) analyseren in [het overzicht van](/help/analysis-workspace/visualizations/journey-canvas/journey-canvas.md) de reiscanvas voor meer informatie.</p><p>**Nota**: Deze optie toont slechts wanneer het gegeven van Journey Optimizer in de zelfde gegevensmening wordt ontdekt die in het paneel van Analysis Workspace wordt geselecteerd waar u de visualisatie toevoegt. Voor informatie over het veranderen van de gegevensmening over een paneel in Analysis Workspace, zie [ overzicht van Analysis Workspace ](/help/analysis-workspace/home.md).</p> |

1. (Facultatief) selecteer [!UICONTROL **tonen geavanceerde montages**], dan specificeer de volgende informatie:

   | Veld | Functie |
   |---------|----------|
   | [!UICONTROL **de container van het canvas van de Reis**] | Kies de container waarop u zich tijdens de reis wilt concentreren. De container die u kiest, bepaalt het bereik van de gegevens die tijdens de reis worden vastgelegd. Dit is van invloed op de statistieken die in de visualisatie worden weergegeven. (Als uw containernamen afwijken van de standaardnamen die hieronder worden weergegeven, zijn ze aangepast in uw gegevensweergave.)<ul><li>**Sessie:** Hiermee beperkt u de statistieken van de visualisatie zodat deze binnen één gedefinieerde sessie voor een bepaalde persoon vallen. Dit betekent dat de getallen en percentages die op elk knooppunt worden weergegeven (die zijn gebaseerd op de primaire en secundaire metrische gegevens) binnen één sessie voor elke persoon moeten voorkomen. Met andere woorden, één persoon kan meerdere keren op één reis vertegenwoordigd zijn.<p>Deze container gebruikt metrische sessies.</p></li><li>**Persoon:** (Gebrek) staat de statistieken van visualisatie toe om veelvoudige zittingen voor een bepaalde persoon te overspannen. Dit betekent dat de aantallen en de percentages die op elke knoop verschijnen (die op de primaire en secundaire metriek gebaseerd zijn) over om het even welk aantal zittingen kunnen voorkomen, zolang de zittingen aan de zelfde persoon behoren. Met andere woorden, één persoon kan slechts één keer op één reis vertegenwoordigd zijn.<p>Deze container gebruikt metrische Mensen.</p></li></ul> |
...
1. Sleep metriek, dimensies, afmetingsitems, filters of datumbereiken van de linkerspoorstaaf naar het canvas. De metriek die op a [ afgeleid gebied ](/help/data-views/derived-fields/derived-fields.md) gebaseerd zijn wordt gesteund. Nochtans, worden de berekende metriek, evenals om het even welke metriek of dimensies die op a [ summiere dataset ](/help/data-views/summary-data.md) gebaseerd zijn niet gesteund.
   ...
   | Dimension | Leeg gebied van het canvas | Er worden 3 knooppunten gemaakt voor de bovenste 3 dimensie-items waar het onderdeel is gedropt, niet verbonden met bestaande knooppunten. (**Opmerking:** Als er slechts 1 of 2 knooppunten worden weergegeven, betekent dit dat er gegevens beschikbaar zijn voor slechts 1 of 2 van de dimensie-items. Als er geen knooppunten worden weergegeven, betekent dit dat er geen gegevens beschikbaar zijn voor een van de dimensie-items. Probeer in dit geval de visualisatie toe te voegen aan een ander punt van de reis, pas de periode van de visualisatie aan of kies een andere dimensie.)<p>Houd Shift ingedrukt wanneer u de dimensie op het canvas neerzet om deze toe te voegen als één knooppunt met 3 dimensie-items.</p><p></p> |
   ...
   | Afmeting artikel | Leeg gebied van canvas | De knoop toont waar de component werd gelaten vallen, los van om het even welke bestaande knopen. |
   | Dimension-item | Een bestaand knooppunt | De component wordt automatisch gecombineerd met het bestaande knooppunt. |
   | Dimension-item | Een pijl die 2 bestaande knopen verbindt | De knoop toont tussen de twee bestaande knopen waar de component werd gelaten vallen en met beide bestaande knopen verbonden. (Zie [Sluit knooppunten](#connect-nodes) aan voor meer informatie.)</p> |
   | Filter | Leeg gebied van het canvas | Het knooppunt geeft aan waar de component is neergezet zonder verbinding met andere knooppunten.<p>Het aantal en het percentage dat op de knoop verschijnen omvatten het totaal van primaire metrisch, gefilterd door de filter u selecteerde.</p> <p>Als Personen bijvoorbeeld is geselecteerd als de primaire metrische waarde voor de rit, worden bij het toevoegen van een filter Vandaag aan een leeg gebied van het canvas alle personen weergegeven die vandaag een gebeurtenis hebben gehad.</p> |
   ...
   | Datumbereik | Een pijl die 2 knooppunten met elkaar verbindt | Het knooppunt wordt weergegeven tussen de twee bestaande knooppunten waar het onderdeel is gedropt en is verbonden met beide bestaande knooppunten. (Zie [Sluit knooppunten](#connect-nodes) aan voor meer informatie.)</p><p>Hiermee past u de periode toe op het punt op het pad waar het onderdeel is neergezet.</p> |
...
1. Ga door met het aanpassen van de reis zoals beschreven in de onderstaande secties. U kunt knooppunten verbinden, knooppunten hernoemen, uitsplitsingen toepassen, doelgroepen maken, tijdsbeperkingen toevoegen en meer.

### Toon de beste knooppunten op basis van bestaande knooppunten
...
U kunt een knooppunt selecteren en de items met de hoogste dimensies weergeven die eraan voorafgaan in de reis. U kunt de bovenste 3 dimensie-items als afzonderlijke knooppunten toevoegen aan het reiscanvas, of u kunt alle items met de hoogste dimensie weergeven in een vrije-vormtabel.

1. Klik met de rechtermuisknop op het knooppunt waar u de items in de bovenste dimensie wilt weergeven die eraan voorafgaan in de reis.

   Dit knooppunt kan geen bestaande knooppunten hebben die tijdens de reis binnenkomen.

1. Selecteer [!UICONTROL **Topknooppunten weergeven vóór dit knooppunt**].
...
1. Selecteer waar u de dimensie-items wilt weergeven:
   ...
   * [!UICONTROL **In Journey canvas**]: Voegt de bovenste 3 knooppunten toe aan het canvas die tussen de 2 bestaande knooppunten komen. Elk knooppunt is verbonden met de omringende knooppunten als een afzonderlijke tak op het canvas.

   * [!UICONTROL **In een vrije-vormtabel**]: hiermee maakt u een visualisatie van een vrije-vormtabel met alle items in de topdimensies die tussen de 2 bestaande knooppunten komen.

1. Selecteer de gewenste afmeting uit de lijst met dimensies.
...
* Sleep vanaf de linkerrail een enkel onderdeel naar een knooppunt op het canvas.
...
| Filter + Metrisch, Datumbereik of Dimensie | Samengevoegd met AND |
...
U verbindt knooppunten om de volgorde van gebeurtenissen van de reis te definiëren.
...
Reizen kunnen niet cirkelvormig zijn en teruglopen naar eerder verbonden knooppunten.

Knooppunten verbinden in het reiscanvas:

1. Beweeg in een visualisatie van het reiscanvas de muisaanwijzer op het knooppunt dat als eerste wordt weergegeven in de reisreeks die u met een ander knooppunt wilt verbinden.
...
* Uitsplitsingen worden toegepast op de primaire metrische gegevens. Dit heeft geen invloed op de secundaire metriek.

* Het toepassen van een pechsituatie verandert niets aan de reis. In plaats daarvan toont het gewoon een uitsplitsing van de gegevens voor het knooppunt waar het wordt toegepast.

* Als een knooppunt al een storing heeft, vervangt het toepassen van een nieuwe storing de bestaande.

* Pechgegevens worden bijgewerkt als er op een eerder punt in de reis wijzigingen worden aangebracht.
...
1. Selecteer de dimensie die u voor de onderverdeling wilt gebruiken.
   ...
   Als u ervoor kiest om de uitsplitsing in een vrije-vormtabel weer te geven, worden de items met de hoogste dimensies weergegeven in een nieuwe vrije-vormtabel direct boven de visualisatie van het reiscanvas.

#### Een uitsplitsing toepassen op een afzonderlijk knooppunt

U kunt een dimensie vanaf de linkerbalk naar het knooppunt op het canvas slepen waarop u de uitsplitsing wilt toepassen.

Zie [Knooppunten](#add-nodes) toevoegen voor meer informatie.
...
1. Klik in een visualisatie van een reiscanvas met de rechtermuisknop op het knooppunt of de pijl die u wilt gebruiken om het filter te maken.

1. Selecteer [!UICONTROL **Filter maken van knooppunt**] of [!UICONTROL **Filter maken van pijl**].

   De filterbouwer wordt weergegeven. In de [!UICONTROL **sectie Definitie**] wordt de filterdefinitie gemaakt op basis van het knooppunt of de pijl die u hebt geselecteerd en de context ervan binnen de reis.

1. Geef een titel op voor het filter en breng eventuele andere wijzigingen aan. Zie [Filter maken](/help/components/filters/filter-builder.md) voor meer informatie over het maken van een filter.

1. Selecteer [!UICONTROL **Opslaan**] om het filter op te slaan.
