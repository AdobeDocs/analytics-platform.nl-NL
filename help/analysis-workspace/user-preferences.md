...
Algemene voorkeuren zijn van toepassing op uw Customer Journey Analytics in de browser. Voor informatie over hoe te om tot deze voorkeur toegang te hebben, zie [ voorkeur van de Update ](#update-preferences).
...
Als u liever een donkere achtergrond voor de gebruikersinterface van de Customer Journey Analytics hebt, kunt u schakelen naar [!UICONTROL Dark theme] .

1. Selecteer het gebruikerspictogram van het Experience Cloud bij het hoogste recht.
