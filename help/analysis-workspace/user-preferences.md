...
| **het becommentariëren van het Project** | | |
| | Opmerkingen over projecten toestaan | Als deze optie is ingeschakeld, is een gebied met opmerkingen beschikbaar op de rechterspoorlijn van elk project in Analysis Workspace. <p>De eigenaars van het project kunnen het commentaargebied voor een bepaald project onbruikbaar maken, zoals die in [ worden beschreven leidt tot projecten ](/help/analysis-workspace/build-workspace-project/create-projects.md).</p> <p>Voor meer informatie over het becommentariëren in de projecten van Analysis Workspace, zie [ commentaren in projecten ](/help/analysis-workspace/build-workspace-project/comment-projects.md) toevoegen en beheren.</p> |
