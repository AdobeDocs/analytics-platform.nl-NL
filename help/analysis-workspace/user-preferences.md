...
1. Ga in Customer Journey Analytics naar de [!UICONTROL **Project**] openingspagina, en selecteer vervolgens [!UICONTROL **Voorkeuren**].
...
1. Voor informatie over de beschikbare voorkeuren op elk tabblad gaat u verder met een van de volgende secties in dit artikel:
   ...
   * [Voorkeuren voor tabellen voor vrije vorm](#freeform-table-preferences)
...
U kunt projectvoorkeuren aanpassen voor alle nieuwe projecten die u in Analysis Workspace maakt. Voor informatie over hoe u deze voorkeuren kunt openen, raadpleegt u [Voorkeuren bijwerken](#update-preferences).

Sommige van deze voorkeuren kunnen ook voor afzonderlijke projecten worden aangepast, zoals wordt beschreven in [Overzicht van project](/help/analysis-workspace/build-workspace-project/freeform-overview.md).
...
|  | Aantal herhalingen | Geeft aan of herhalingsinstanties worden geteld in rapporten. Met deze instelling (indien geactiveerd) worden bijvoorbeeld meerdere weergaven van opeenvolgende pagina&#39;s op dezelfde pagina behandeld als weergaven van meerdere pagina&#39;s. Als deze is uitgeschakeld, tellen ze als een weergave van één pagina. <p>**Opmerking:** Deze instelling heeft alleen invloed op bepaalde metriek (zoals Bezoekingen voor één pagina) en is niet van toepassing op de stroomweergave of op de uitvalweergave.</p> |
...
## Voorkeuren voor tabellen voor vrije vorm
...
|  | Uitsplitsing naar positie | Selecteer deze optie als u wilt dat de uitsplitsing bij de positie van het item blijft en niet bij het item zelf. Voor meer informatie over uitsplitsingen raadpleegt u [Afmetingen onderverdelingen](/help/components/dimensions/t-breakdown-fa.md). |
...
|  | min. tonen | Bedek een label voor een minimumwaarde om de dalen snel in metrische vorm te markeren. Opmerking: De minimale waarden worden afgeleid van de zichtbare gegevenspunten in de visualisatie, niet van de volledige reeks waarden binnen een dimensie. |
...
|  | Voorvertoning van kleur | Een voorvertoning van de manier waarop het kleurenpalet in de cohortvisualisatie wordt weergegeven. |
...
|  | max. en min. tonen op vonklines | Minimum- en maximumwaarden tonen op primaire en vergelijkingslijngrafieken. |
...
1. Selecteer in de rechterbovenhoek de optie **[!UICONTROL Restore defaults]**.
