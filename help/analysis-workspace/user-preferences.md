...
>[!IMPORTANT]
>
>U kunt de getalnotatie niet meer definiëren in de sectie **[!UICONTROL Project & Analyses]** > **[!UICONTROL Data]** van **[!UICONTROL User preferences]** . Het aantalformaat wordt automatisch bepaald door de [&#x200B; standaardtaal die &#x200B;](https://experienceleague.adobe.com/nl/docs/core-services/interface/features/browser-language) voor de het programma geopende gebruiker wordt gevormd.
>
