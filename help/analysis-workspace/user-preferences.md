...
Algemene voorkeuren gelden voor uw Customer Journey Analytics-ervaring in de browser. Voor informatie over hoe te om tot deze voorkeur toegang te hebben, zie [&#x200B; voorkeur &#x200B;](#edit-preferences) uitgeven.
...
U kunt bedrijfvoorkeur bijwerken die op alle gebruikers en projecten binnen uw organisatie van toepassing is. Voor informatie over hoe te om tot deze voorkeur toegang te hebben, zie [&#x200B; voorkeur &#x200B;](#edit-preferences) uitgeven.
...
U kunt deze voorkeuren aanpassen voor alle nieuwe Analysis Workspace-projecten, nieuwe Analysis Workspace-deelvensters en nieuwe analyses met instructies. Voor informatie over hoe te om tot deze voorkeur toegang te hebben, zie [&#x200B; voorkeur &#x200B;](#edit-preferences) uitgeven.
...
U kunt de voorkeuren voor vrije-vormtabellen aanpassen voor alle nieuwe projecten die u in Analysis Workspace maakt. Voor informatie over hoe te om tot deze voorkeur toegang te hebben, zie [&#x200B; voorkeur &#x200B;](#edit-preferences) uitgeven.
...
| | Totalen tonen | Dit totale aantal is typisch gelijk aan of een ondergroep van [!UICONTROL Grand Total]. Alle tabelsegmenten die zijn toegepast in de vrije-vormtabel, inclusief de optie [!UICONTROL Include None] . |
...
>abstract="Selecteer de standaardtelmethode die u voor [!UICONTROL Histogram] -visualisaties wilt gebruiken. Als de geselecteerde gegevensweergave niet de geselecteerde standaardtelmethode bevat, schakelt de [!UICONTROL Histogram] -visualisatie automatisch over naar een andere primaire telmethode."
...
U kunt de visualisatievoorkeuren bijwerken voor alle nieuwe projecten die u in Analysis Workspace maakt. Voor informatie over hoe te om tot deze voorkeur toegang te hebben, zie [&#x200B; voorkeur &#x200B;](#edit-preferences) uitgeven.
...
| | Legenda zichtbaar | Hiermee kunt u de gedetailleerde legenda voor alle visualisaties verbergen. |
| | Maximaal aantal items beperken | Hiermee verkleint u het aantal items op de X-as voor alle visualisaties. Deze voorkeur kan nuttig zijn als u een grote dataset hebt. |
...
| | Schalen van Y-as toestaan voor prognoses | Als u prognosewaarden hebt die buiten de bovenste en onderste grenzen van de historische waarden vallen, worden deze voorspelde waarden niet automatisch geschaald op de y-as. Als u deze optie inschakelt, wordt de y-as voor de voorspelde waarden niet goed geschaald. |
...
| | [!BADGE &#x200B; B2B Uitgave &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"} <br/> Container | Selecteer de aangewezen container voor cohortanalyse in het geval van een op rekening-gebaseerde [!BADGE &#x200B; verbinding 0&rbrace; B2B van de Uitgave &lbrace;.]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"} <p>De volgende opties zijn beschikbaar:</p> <ul><li>Globale Rekeningen [!BADGE &#x200B; B2B Uitgave &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Accounts [!BADGE &#x200B; B2B Uitgave &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Het kopen van Groepen [!BADGE &#x200B; B2B Uitgave &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Kansen [!BADGE &#x200B; B2B Uitgave &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Persoon</li></ul> |
...
| | Percentages afronden naar dichtstbijzijnde gehele getal | Rondt de percentagewaarde af op het dichtstbijzijnde gehele getal in plaats van de decimale waarde weer te geven. |
| | Gemiddelde percentagerij weergeven | Hiermee voegt u een nieuwe rij boven aan de tabel in en voegt u vervolgens het gemiddelde voor de waarden in elke kolom toe. |
...
| | Labels voor tekstomloop | Normaal gesproken worden de labels op de Flow-elementen afgebroken om schermruimte op te slaan, maar u kunt het hele label zichtbaar maken door dit vakje aan te vinken. Standaard = uitgeschakeld. |
| | Herhalingsinstanties opnemen | Stroomvisualisaties zijn gebaseerd op instanties van een dimensie. Deze instelling biedt u de mogelijkheid om herhaalde exemplaren op te nemen of uit te sluiten, bijvoorbeeld pagina&#39;s opnieuw worden geladen. Herhalingen kunnen echter niet worden verwijderd uit Flow-visualisaties met meerdere waardering, zoals listVars, listProps, s.product, merchandising eVars, enz. Standaard = uitgeschakeld. |
...
| | Container | Selecteer de voorkeurscontainer voor het analyseren van het plakwerk. De aangewezen container helpt u om rekeningsovereenkomst op diverse B2B containerniveaus [!BADGE &#x200B; B2B Uitgave &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}, persoonbetrokkenheid op het persoonniveau (over zittingen) te begrijpen, of de analyse te beperken tot één enkele zitting. <p>De volgende opties zijn beschikbaar:</p> <ul><li>Globale Rekeningen [!BADGE &#x200B; B2B edition &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Rekeningen [!BADGE &#x200B; B2B edition &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Het kopen van Groepen [!BADGE &#x200B; B2B edition &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Kansen [!BADGE &#x200B; B2B edition &#x200B;]{type=Informative url="https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B edition"}</li><li>Sessie</li><li>Persoon</li></ul> |
...
| | Legenda zichtbaar | Hiermee kunt u de gedetailleerde legenda-tekst voor de visualisatie van het overzichtsnummer verbergen. |
...
| | Percentage | Hiermee worden waarden in percentages voor de Treemap-visualisaties weergegeven. |
| | Maximaal aantal items beperken | Hiermee verkleint u het aantal items op de X-as in de Treemap-visualisatie. Deze voorkeur kan nuttig zijn als u een grote dataset hebt. |
| **[Venn](/help/analysis-workspace/visualizations/venn.md)** | | |
| | Legenda zichtbaar | Hiermee kunt u de gedetailleerde legenda-tekst voor de Venn-visualisatie verbergen. |
| **[Spreiding](/help/analysis-workspace/visualizations/scatterplot.md)** | | |
| | Percentage | Hiermee geeft u de waarden in percentages voor de verstrooiingsvisualisaties weer. |
| | Legenda zichtbaar | Hiermee kunt u de gedetailleerde legenda-tekst voor de verstrooiingsvisualisatie verbergen. |
...
U kunt al uw gebruikersvoorkeuren herstellen naar de standaardwaarden van het systeem. Deze voorkeur heeft geen invloed op de beheerdersvoorkeuren op het tabblad Bedrijf.
