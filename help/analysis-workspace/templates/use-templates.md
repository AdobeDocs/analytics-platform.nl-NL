...
* Hoeveel mensen bezoeken uw site.
* Hoeveel van deze bezoekers zijn unieke bezoekers (slechts eenmaal geteld).
* Hoe ze naar de site kwamen (bijvoorbeeld of ze een link volgden of er rechtstreeks naartoe kwamen).
* Welke trefwoorden bezoekers hebben gebruikt om site-inhoud te zoeken.
* Hoe lang bezoekers op een bepaalde pagina of op de hele site bleven.
* Welke verbindingen bezoekers klikte, en wanneer zij de plaats verlieten.
* Welke marketing kanalen het meest effectief zijn bij het produceren van opbrengst of omzettingsgebeurtenissen.
* Hoeveel tijd hebben ze besteed aan het bekijken van een video.
* Welke browsers en apparaten hebben ze gebruikt om uw site te bezoeken.
...
| [!UICONTROL **Volgende pagina**] | Bekijk de meest gangbare plaatsen die mensen direct na het bezoeken van een bepaalde pagina bezoeken. <p>**dit kan u helpen** beter gebruikersgedrag na het bezoeken van een bepaalde pagina begrijpen.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als beoordelen of het paginaontwerp of de lay-out zouden kunnen worden geoptimaliseerd om mensen aan wenselijke pagina&#39;s, zoals een pagina te leiden om een aankoop te maken of een overzicht te verlaten.</p> <p>In deze sjabloon worden de afmetingen Pagina en Gebeurtenissen gebruikt.</p> |
| [!UICONTROL **Vorige pagina**] | Bekijk de meest gangbare plaatsen die mensen direct bezoeken voordat ze een bepaalde pagina bezoeken. <p>**dit kan u helpen** beter begrijpen welke pagina&#39;s het meeste verkeer aan een bepaalde pagina leiden.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als beoordeling of de pagina&#39;s die niet verschijnen aangezien vorige pagina&#39;s prominentere verbindingen aan de huidige pagina nodig hebben.</p><p>In deze sjabloon worden de afmetingen Pagina en Gebeurtenissen gebruikt.</p> |
| [!UICONTROL **het Volgen code**] | Bekijk de koppelingen die het meest succesvol zijn geweest in het besturen van verkeer naar uw site. <p>**dit kan u helpen** beter begrijpen welke het volgen codes (en de verbindingen zij met) worden geassocieerd het meest gebruikt in de toegang tot van uw plaats.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw strategie aanpassen waar u verbindingen aan uw plaats toevoegt.</p><p>Deze sjabloon gebruikt de dimensie Tracking Code en de metrische bezoekers.</p> |
...
| [!UICONTROL **de inhoudsconsumptie van het Web**] | Bekijk welke webinhoud het meest wordt verbruikt en aantrekkelijke gebruikers is.<p>**dit kan u helpen** beter begrijpen waar de mensen op eerste het ingaan van de plaats gaan, welke secties van de plaatsmensen het meest bezoeken, en welke pagina&#39;s hoogstwaarschijnlijk mensen weg van de plaats zullen drijven.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als evalueert welke wegen op de plaats mensen tot de belangrijkste pagina&#39;s drijven, en welke pagina&#39;s eerder mensen buiten de plaats zullen leiden.</p> <p>Deze sjabloon gebruikt de afmetingen van de Pagina en de metrische weergave van de Pagina, de metrische bezoekers, de metrische waarde van de Unieke bezoekers, de maateenheid van de Invoersnelheid, de meeteenheid voor Stuitsnelheid, de maateenheid Afsluitingsfrequentie en de metrische waarde voor Inhoudssnelheid. Het gebruikt ook de visualisaties van de Stroom voor ingang, uitgang, en hoogste secties.</p> |
...
>title="Bekijk vooraf gebouwde inzichten voor detailhandelaren over uw handelsactiviteiten om verkoop te helpen verbeteren. Dit is gericht op gebruikers van Adobe Commerce, maar kan door om het even welke online retailer worden gebruikt."
...
>title="Bekijk welk publiek wordt vertegenwoordigd door de mensen die uw site bezoeken."
>abstract="**dit kan u helpen** beter algemene informatie over het publiek begrijpen, waar het publiek (RTCDP, Customer Journey Analytics, etc.) voortkwam, overlap, en meer.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als gebruik de gegevens om zich op marketing inspanningen voor deze specifieke doelgroepen te concentreren, of tot gemaakte ervaringen voor klanten leiden die veelvoudige publiek omspannen.<br/> dit malplaatje gebruikt de Naam van het Publiek, de Oorsprong van het Publiek, de Bewegende Naam van het Publiek, en de Bewegde dimensies van de Oorsprong van het Publiek."
...
| Sjabloonnaam | Waarom deze sjabloon gebruiken <!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| **[!UICONTROL Audience overview]** | Bekijk welk publiek wordt vertegenwoordigd door de mensen die uw site bezoeken.<p>**dit kan u helpen** beter algemene informatie over het publiek begrijpen, waar het publiek (RTCDP, Customer Journey Analytics, etc.) voortkwam, overlap, en meer.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als gebruik de gegevens om zich op marketing inspanningen voor deze specifieke doelgroepen te concentreren, of tot gemaakte ervaringen voor klanten leiden die veelvoudige publiek omspannen.</p><p>Deze sjabloon gebruikt de Audience Name, Audience Origin, Exited Audience Name, en Exited Audience Origin afmetingen.</p><p>Voor meer informatie, zie [ het publiek van Experience Platform in Customer Journey Analytics ](/help/connections/audience-analysis/analyze-audiences.md) analyseren.</p> |
...
| **Overzicht van de Technologie** | Informatie weergeven over de technologie die mensen gebruiken om toegang te krijgen tot uw site, zoals besturingssystemen, browsers en apparaten. <p>**dit kan u helpen** beter begrijpen welke technologieën het vaakst wanneer het toegang tot van uw plaats worden gebruikt.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als optimaliseer uw plaats voor de technologieën die worden gebruikt.</p> |
...
>abstract="**dit kan u helpen** beter de sleutelwoorden begrijpen mensen in onderzoeken gebruiken die in plaatsverkeer resulteren. <br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als identificeer en vul SEO hiaten tussen gebruikte sleutelwoorden en die die plaatsverkeer drijven.<br/> Dit malplaatje gebruikt de afmeting van het Sleutelwoord van het Onderzoek."
...
>abstract="**dit kan u helpen** beter de sleutelwoorden begrijpen mensen in onderzoeken gebruiken die in plaatsverkeer resulteren.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als identificeer en vul SEO hiaten tussen gebruikte sleutelwoorden en die die plaatsverkeer drijven. <br/> Dit malplaatje gebruikt het Trefwoord van het Onderzoek - Betaalde afmeting. "
...
>abstract="**dit kan u helpen** beter de sleutelwoorden begrijpen mensen in onderzoeken gebruiken die in plaatsverkeer resulteren.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als identificeer en vul SEO hiaten tussen gebruikte sleutelwoorden en die die plaatsverkeer drijven.<br/> Dit malplaatje gebruikt het Sleutelwoord van het Onderzoek - Natuurlijke afmeting. "
...
>abstract="**dit kan u helpen** beter begrijpen hoe de mensen uw app en de waarde gebruiken die zij van het krijgen.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als ontwikkelt eigenschappen die compliment of op die verbeteren die het populairst zijn."
...
>title="Bekijk welke gebruikers de meest loyale klanten van uw app zijn en wat ze in de app doen."
>abstract="**dit kan u helpen** beter begrijpen hoe uw meest loyale klanten uw app gebruiken.<br/>**gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw marketing inspanningen voor de eigenschappen verbeteren die uw meest loyale klanten gebruiken."
...
| **Mobiele app reizen** | Bekijk de opvallende gebruikspatronen voor uw mobiele app. <p>**dit kan u** helpen beter begrijpen hoe de mensen uw app gebruiken. </p><p>**gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als verbeteren hoe de mensen van één scherm aan een andere kunnen krijgen om de gemeenschappelijkste werkschema&#39;s te richten. </p><!-- This template uses the --> |
| **Mobiele toepassingsmetriek** | Bekijk enkele van de meest gangbare maatstaven voor mobiele apps. <p>**dit kan u** helpen de basisprestaties van uw mobiele app beter begrijpen.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, zoals de algemene gezondheid en de prestaties van uw app beoordelen.</p><!-- This template uses the --> |
...
| **Mobiele toepassingsprestaties** | Bekijk hoe uw app presteert en waar gebruikers problemen ondervinden. <p>**dit kan u helpen** beter begrijpen als de mensen die uw app gebruiken langzame of degraded prestaties tegenkomen. </p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als moeilijke situatie bestaande kwesties of verbetert app prestaties alvorens de kwesties voorkomen.</p><!-- This template uses the --> |
| **Mobiele toepassingsbehoud** | Bekijk welke gebruikers de meest loyale klanten van uw app zijn en wat ze in de app doen. <p>**dit kan u helpen** beter begrijpen hoe uw meest loyale klanten uw app gebruiken.</p><p>**gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw marketing inspanningen voor de eigenschappen verbeteren die uw meest loyale klanten gebruiken.</p><!-- This template uses the --> |
...
| **de centrumvervorming van de Vraag** | Bekijk hoe het Webverkeer het verkeer van het vraagcentrum beïnvloedt.<p>**dit kan u helpen** beter begrijpen hoe met succes de zelfbediening inhoud op uw website verkeer aan uw vraagcentrum afleidt.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als zelfbediening inhoud verbeteren om verkeer aan uw vraagcentrum te verminderen, of ROI van uw zelfbediening inhoud te meten door het bedrag te berekenen dat door minder steunvraag wordt bewaard.</p><p>Deze sjabloon gebruikt de metriek Websessies, Mobiele App-sessies en Web+App voor verschillende sessies.</p> |

### Andere kanalen {#other-channels}

>[!CONTEXTUALHELP]
>id="cja-template--callcenterdashboard"
>title="De gegevens van het vraagcentrum van de mening, met inbegrip van waarom de klanten en het aantal tijden riepen."
>abstract="**dit kan u helpen** beter begrijpen waar de klanten problemen ervaren en waar de middelen van het vraagcentrum worden besteed.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen, zoals de kwesties van het adresproduct kunnen doen die het hogere verkeer van het vraagcentrum drijven, uiteindelijk verbeterend productrentabiliteit."
...
>abstract="**dit kan u** helpen beter begrijpen welke uw top-verkopende producten over opslagplaatsen en online zijn.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als meer marketing middelen aan uw best-presterende producten en kanalen toewijzen."

>[!CONTEXTUALHELP]
>id="cja-template--ajo-email"
>title="Bekijk hoe de e-mails die u ontwerpt en verzendt met Adobe Journey Optimizer, nieuwe lidmaatschappen, loyaliteitsleden en mogelijkheden voor kruisverkoop genereren."
>abstract="**dit kan u helpen** beter de doeltreffendheid van e-mails begrijpen die u ontwerpt en verzendt gebruikend Adobe Journey Optimizer.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw e-mailstrategie voor een bepaalde e-mailcampagne aanpassen."
...
>title="Bekijk hoe uw organisatie Customer Journey Analytics gebruikt."
>abstract="**dit kan u helpen** beter begrijpen hoeveel mensen in uw organisatie Customer Journey Analytics gebruiken, hoe vaak zij het gebruiken, en die gegevens in tijd trenderen. U kunt ook het aantal gemaakte projecten en details over die projecten zien. Zie welke componenten, visualisaties, en panelen het meest meestal worden gebruikt, onder andere gebruiksstatistieken.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, zoals schrapping ongebruikte projecten of componenten, of gebruikersopleiding voor populaire eigenschappen verstrekken."
...
| **Onderzoek** | Bekijk de betrokkenheid van gebruikers voor uw enquêtes. Bekijk het aantal start- en voltooiingsopdrachten, de bovenste vragen en antwoorden en het aantal eerste versus vorige deelnemers.<p>**dit kan u** helpen de betrokkenheidsniveaus en het succestarief van uw onderzoeken beter begrijpen.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als toekomstige onderzoeken aanpassen om betere participatie te produceren.</p><p>In deze sjabloon worden de volgende cijfers gebruikt: Gebruikers, Gebeurtenissen, Starten van enquête, Voltooien van enquête en Eindpercentage van enquête.</p> |
| **overzicht van het het gebruiksgebruik van het Product** | Bekijk hoe uw organisatie Customer Journey Analytics gebruikt.<p>**dit kan u helpen** beter begrijpen hoeveel mensen in uw organisatie Customer Journey Analytics gebruiken, hoe vaak zij het gebruiken, en die gegevens in tijd trenderen. U kunt ook het aantal gemaakte projecten en details over die projecten zien. Zie welke componenten, visualisaties, en panelen het meest meestal worden gebruikt, onder andere gebruiksstatistieken. [Meer informatie](/help/tools/product-usage/usage-overview.md)</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, zoals schrapping ongebruikte projecten of componenten, of gebruikersopleiding voor populaire eigenschappen verstrekken.</p> |
...
>abstract="**dit kan u helpen** beter details zoals het aantal kliks en het aantal geleverde berichten begrijpen, die uitgebreide insight in de doeltreffendheid en het niveau van betrokkenheid van uw campagne aanbieden.<br/>**gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw campagnes aanpassen die op de betrokkenheidsniveaus van uw doelpubliek worden gebaseerd."
...
>abstract="**dit kan u helpen** beter details zoals het aantal kliks en aantal geleverde berichten begrijpen, die uitvoerige insight in de doeltreffendheid en het niveau van betrokkenheid van uw reis aanbieden.<br/>**gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw campagnes aanpassen die op de betrokkenheidsniveaus van uw doelpubliek worden gebaseerd."
...
>title="Analyseer gebruikersbetrokkenheid door gesprekspatronen, gebruikersfeedback, en de doeltreffendheid van uw aanbevelingen."
>abstract="**dit kan u** helpen betrokkenheidspatronen identificeren, gesprekskwaliteit evalueren, trends van de klantentevredenheid volgen, en de doeltreffendheid van verbindingsaanbevelingen meten.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, zoals de reacties van uw AI agent verfijnen, gerichte inhoud voor frequente kwesties ontwikkelen, aanbevelingen algoritmen verbeteren, of gespecialiseerde wegen voor verschillende gebruikerssegmenten creëren."

>[!CONTEXTUALHELP]
>id="template--brand-concierge--meeting"
>title="Volg de volledige levenscyclus van B2B vergaderingsverzoeken. Bewaak de conversiesnelheden, de prestaties van de consultant en identificeer uw meest effectieve kanalen voor de productie van lood."
...
>title="Kijk hoe actief uw accounts zijn op verschillende gebeurtenissen, mensen en mogelijkheden."
>abstract="**dit kan u helpen** beter begrijpen of de overeenkomst op het rekeningsniveau omhoog of neer trending, activiteit over rekeningen vergelijkt, en beslist waar te om behoud of verwervingsinspanningen te concentreren.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als uw aandacht op die rekeningen heroriënteren die minder betrokken zijn maar meer aandacht wegens het belang van de rekening vereisen."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-opportunity-engagement"
>title="De betrokkenheid van het spoor op het opportuniteitsniveau en oppervlaktetransacties die of trekkracht verliezen."
>abstract="**dit kan u** helpen om overeenkomstenvooruitgang nauwkeuriger en nadrukactivering te voorspellen waar de overeenkomst of de stallen piekt.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als wat extra inspanningen op overeenkomsten zetten die bijna gesloten zijn, en onderzoek waarom andere overeenkomsten tractie verliezen."

>[!CONTEXTUALHELP]
>id="cja-template--b2b-buying-group-activity"
>title="Visualiseer de koopgroepsactiviteit binnen elke rekening om rekening en het kopen groepsmarketing spelen te informeren."
>abstract="**dit kan u** helpen visualiseren welke het kopen groepen, en welke mensen binnen die het kopen groepen, het meest betrokken zijn, die hiaten in groepsparticipatie benadrukken.<br/>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, als het proberen om meer met mensen in het kopen van groepen in dienst te nemen die niet schijnen betrokken te zijn."
...
### Mix Modeler-sjablonen {#mix-modeler-templates}

De volgende sjablonen zijn beschikbaar:

| Sjabloonnaam | Waarom deze sjabloon gebruiken <!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- |
| [!UICONTROL **de stijgende modelinzichten van Mix Modeler**] | Bekijk inzichten van geselecteerde modellen die door Mix Modeler zijn gegenereerd.<p>**dit kan u** helpen de stijgende inzichten van modellen beter begrijpen die in Mix Modeler worden geproduceerd. <p>**gebaseerd op deze inzichten** u zult kunnen:<ul><li>De impact van de marketingactiviteiten van uw organisatie visualiseren en kwantificeren.</li><li>Identificeer welke kanalen hoog presteren.</li><li>Bepaal welke kanalen eventueel moeten worden geoptimaliseerd.</li></ul></p> |

<!-- CJA only -->

>[!CONTEXTUALHELP]
>id="template--mixmodeler-incremental-models-insights"
>title="Bekijk inzichten van geselecteerde modellen die door Mix Modeler zijn gegenereerd."
>abstract="**dit kan u** helpen de stijgende inzichten van modellen beter begrijpen die in Mix Modeler worden geproduceerd. <br/>**gebaseerd op deze inzichten** u zult kunnen:<ul><li>De impact van de marketingactiviteiten van uw organisatie visualiseren en kwantificeren.</li><li>Identificeer welke kanalen hoog presteren.</li><li>Bepaal welke kanalen eventueel moeten worden geoptimaliseerd.</li></ul>"
