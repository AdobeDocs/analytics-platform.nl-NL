...
| **overzicht van het het gebruiksgebruik van het Product** | Bekijk hoe uw organisatie Customer Journey Analytics gebruikt.<p>**dit kan u helpen** beter begrijpen hoeveel mensen in uw organisatie Customer Journey Analytics gebruiken, hoe vaak zij het gebruiken, en die gegevens in tijd trenderen. U kunt ook het aantal gemaakte projecten en details over die projecten zien. Zie welke componenten, visualisaties, en panelen het meest meestal worden gebruikt, onder andere gebruiksstatistieken.</p><p>**Gebaseerd op wat u leert, zou u** om het even welk aantal dingen kunnen doen, zoals schrapping ongebruikte projecten of componenten, of gebruikersopleiding voor populaire eigenschappen verstrekken.</p> |
