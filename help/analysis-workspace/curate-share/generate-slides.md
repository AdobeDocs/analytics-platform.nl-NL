...
>[!NOTE]
>
>Het vertellen van gegevens is een vaardigheid onder Data Insights Agent en is beschikbaar aan in aanmerking komende klanten voor een beperkte tijd. De toegang tot Data Insights Agent loopt af op 28 februari 2026. Als u Data Insights Agent of andere Adobe Experience Platform Agents zonder onderbreking wilt blijven gebruiken, neemt u contact op met uw Adobe-accountvertegenwoordiger voor meer informatie over het in licentie geven van Adobe Experience Platform Agent Orchestrator.
...
1. (Voorwaardelijk) Selecteer **[!UICONTROL Upload template]** als uw diapresentatie moet overeenkomen met een bedrijfsthema. Voor deze optie moet u een aangepaste sjabloon uploaden en aangepaste stijlen toepassen.
   ...
   1. Sleep de aangepaste sjabloon vanuit het bestandssysteem naar het neerzetgebied.
      ...
      Er worden maximaal 25 stramienlay-outs ondersteund.
...
* Sommige visualisaties
   ...
   * Vrije-vormtabellen met meerdere afmetingskolommen (tabellen met één afmetingskolom worden ondersteund)
...
* Uitsplitsingen
  ...
  Als onderdeel van het deduplicatie- en scoring-proces bij het genereren van relevante inzichten wordt elke uitsplitsing binnen een vrije-vormtabel onafhankelijk geanalyseerd en worden alleen de eerste vijf uitsplitsingen binnen één vrije-vormtabel geanalyseerd.

  Alleen het eerste niveau van een uitsplitsing wordt ondersteund. Een uitsplitsing van een uitsplitsing wordt niet in de presentatie opgenomen.
