...
|---|---|---|---|
| **[!UICONTROL Create segment...]** | **[!UICONTROL *shift+cmd+e *]** | **[!UICONTROL *shift+ctrl+e *]** | Creeer een nieuw [&#x200B; segment &#x200B;](/help/components/segments/seg-create.md). |
...
| **[!UICONTROL Send file]** | **[!UICONTROL opt+s]** | **[!UICONTROL *alt+s *]** | [&#x200B; verzend het project als CSV of dossier van PDF aan andere ontvangers &#x200B;](/help/analysis-workspace/curate-share/send-schedule-files.md). |
