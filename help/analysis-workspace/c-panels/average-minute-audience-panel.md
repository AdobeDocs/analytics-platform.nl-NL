...
1. Met [!UICONTROL **Specifieke inhoud**] die in [!UICONTROL **wordt geselecteerd berekent metrisch voor**] drop-down menu, uitgezocht [!UICONTROL **toon geavanceerde montages**], dan specificeer de volgende configuratieopties:
   ...
   | Opties | Beschrijving |
   |---------|------------|
   | **[!UICONTROL Table settings]** | Met de standaardoptie **[!UICONTROL Show calculation values in table]** worden de teller en de noemer van de gemiddelde doelgroep weergegeven als de voorgaande kolommen in de tabel. Als u de selectie van deze optie opheffen, worden deze twee kolommen verwijderd. De kolom met de gemiddelde minuten doelgroep blijft in de tabel naast de videonaam of inhouds-id staan. |
   | **[!UICONTROL Time spent metric]** | U kunt de standaardoptie **[!UICONTROL Content Time Spent]** kiezen, waarbij alleen de inhoudstijd is opgegeven. Of u kunt ervoor kiezen om , waarin inhoud en advertentietijd zijn opgegeven, te gebruiken **[!UICONTROL Media Time Spent]** als tellerberekening voor de gemiddelde doelgroep. |

1. Selecteer [!UICONTROL **Samenstellen**] om het deelvenster Met gemiddelde mediaminuten te voltooien.
