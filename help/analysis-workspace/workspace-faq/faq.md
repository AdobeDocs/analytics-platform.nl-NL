...
| Vraag | Antwoord |
|--- |--- |
| Wat zijn de eerste vereisten voor het gebruik van Analysis Workspace? | Voor het gebruik van Analysis Workspace is een werkende Customer Journey Analytics-implementatie vereist. Zorg ervoor dat uw organisatie gegevens naar het Adobe Experience Platform verzendt voordat u het gereedschap gebruikt. |
...
| Hoe kan ik de prestaties van Analysis Workspace optimaliseren? | Zie [Prestaties](/help/analysis-workspace/workspace-faq/optimizing-performance.md)optimaliseren. |
