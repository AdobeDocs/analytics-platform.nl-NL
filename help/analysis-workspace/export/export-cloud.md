...
## Vereisten en niet-ondersteunde functies {#export-requirements}

In deze sectie worden de minimumvereisten en niet-ondersteunde functies beschreven waarmee u rekening moet houden wanneer u gegevens exporteert.
...
## Vergelijking van de volledige uitvoer van tabellen (in Customer Journey Analytics) naar Data Warehouse (in Adobe Analytics) {#comparison}
