...
description: Leer hoe u op Content Analytics rapporteert met gebruik van visualisaties zoals een vrije-vormtabel, balk en spreiding.
...
Op basis van de specifieke Content Analytics-afmetingen die u in uw project gebruikt, worden miniaturen weergegeven in de volgende visualisaties:
...
### Balk (gestapeld) en Horizontale balk (gestapeld)
