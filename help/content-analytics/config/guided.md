...
{de configuraties van de Analytics van 0} Inhoud 
Voor elke configuratie zijn de volgende details beschikbaar:![&#128279;](../assets/aca-configuration-table.png)
...
1. Een gegevensweergave selecteren
   ...
   * Om de lijst van beschikbare gegevensmeningen te filtreren, selecteer ![ filter ](/help/assets/icons/Filter.svg) tonen. U kunt de lijst filteren op [!UICONTROL Connection] , [!UICONTROL Owner] en [!UICONTROL Sandbox] .![ Verbergen van het gebruik ](/help/assets/icons/Filter.svg) **[!UICONTROL Hide segments]** om de segmentruit te verbergen.<br/>
