...
>title="Verbinding"
>abstract="Selecteer een bestaande verbinding vanuit Customer Journey Analytics waarmee u uw Content Analytics-gegevens wilt samenvoegen."
...
>title="Gegevens, weergave"
>abstract="Voor de configuratie van Content Analytics moet u een of meer gegevensweergaven selecteren. U kunt uw Content Analytics-gegevens dus samenvoegen met andere gegevens."

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataviews_header"
>title="Gegevensweergaven"
>abstract="Selecteer een of meer bestaande gegevensweergaven in Customer Journey Analytics waarmee u uw Content Analytics-gegevens wilt samenvoegen."

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataviews_header_alt"
>title="Gegevensweergaven"
>abstract="Selecteer een of meer bestaande gegevensweergaven in Customer Journey Analytics waarmee u uw Content Analytics-gegevens wilt samenvoegen.<br/>"

>[!CONTEXTUALHELP]
>id="aca_onboarding_dataviews_new_dialog"
>title="Geselecteerde gegevensweergaven"
>abstract="U hebt de geselecteerde gegevensweergaven voor deze configuratie gewijzigd. De geselecteerde gegevensweergaven worden bijgewerkt met Content Analytics-meetgegevens en -afmetingen. Deze metriek en afmetingen worden verwijderd uit vorige geselecteerde gegevensweergaven die niet meer zijn geselecteerd.<br/><br/> als een verschillende verbinding met de geselecteerde gegevensmeningen wordt geassocieerd dan zal de verbinding worden bijgewerkt om de datasets van Content Analytics te omvatten. De datasets van Content Analytics worden niet verwijderd uit de oorspronkelijk geselecteerde verbinding.<br/><br/> Alle geselecteerde gegevensmeningen erven de kanalen die deel van deze configuratie uitmaken."
...
>title="Geselecteerde gegevensweergaven"
>abstract="U hebt de geselecteerde gegevensweergaven voor deze configuratie gewijzigd. De geselecteerde gegevensweergaven worden bijgewerkt met Content Analytics-meetgegevens en -afmetingen. Deze metriek en afmetingen worden verwijderd uit eerder geselecteerde gegevensweergaven die niet meer zijn geselecteerd.<br/><br/> als een verschillende verbinding met de geselecteerde gegevensmeningen wordt geassocieerd dan zal de verbinding worden bijgewerkt om de datasets van Content Analytics te omvatten. De datasets van Content Analytics worden niet verwijderd uit de oorspronkelijk geselecteerde verbinding.<br/><br/> Alle geselecteerde gegevensmeningen erven de kanalen die deel van deze configuratie uitmaken."
...
>title="Kanalen"
>abstract="Laat en vorm één of meerdere kanalen voor de configuratie toe."

>[!CONTEXTUALHELP]
>id="aca_onboarding_channels_header"
>title="Kanalen"
>abstract="Laat en vorm één of meerdere kanalen voor de configuratie toe. Alle gegevensmeningen die deel van de configuratie uitmaken erven de toegelaten kanalen."
...
>title="Webpagina&#39;s, gegevensverzameling"
>abstract="**Pagina&#39;s om te omvatten/uit te sluiten**"
...
>title="Gegevensverzameling webelementen"
>abstract="**Assets om te omvatten/uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_web_assets_header"
>title="Gegevensverzameling webelementen"
>abstract="Wijs op welke activa **inbegrepen** of **&#x200B;**&#x200B;wanneer het verzamelen van gegevens voor Content Analytics zou moeten zijn uitgesloten."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_experience_locations_boldheader"
>title="Mobiele locaties verzamelen gegevens"
>abstract="**plaatsen van de Ervaring om uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_experience_locations_header"
>title="Mobiele locaties verzamelen gegevens"
>abstract="Wijs op welke ervaringsplaatsen **&#x200B;**&#x200B;zou moeten worden uitgesloten wanneer het verzamelen van gegevens voor Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_locations_boldheader"
>title="Gegevensverzameling mobiele middelenlocaties"
>abstract="**plaatsen van Activa om uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_locations_header"
>title="Gegevensverzameling mobiele middelenlocaties"
>abstract="Wijs op welke activa plaatsen **&#x200B;**&#x200B;zou moeten worden uitgesloten wanneer het verzamelen van gegevens voor Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_urls_boldheader"
>title="URL&#39;s met gegevens over mobiele elementen"
>abstract="**Middel URLs om uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_urls_header"
>title="URL&#39;s met gegevens over mobiele elementen"
>abstract="Wijs op welke activa URLs **zou moeten worden uitgesloten** wanneer het verzamelen van gegevens voor Content Analytics."
...
>title="Overschrijvingen koptekst"
>abstract="**Hoog treedt met voeten kopbal**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_header_overrides_header"
>title="Overschrijvingen koptekst"
>abstract="Geavanceerde functie voor het omzeilen van zowel detectie- als poortverkeer. Content Analytics bevat uw aangepaste HTTP-headers wanneer u uw eindpunten aanroept."
