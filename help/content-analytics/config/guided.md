...
>abstract="**plaatsen van de Ervaring om te omvatten/uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_experience_locations_header"
>title="Mobiele locaties verzamelen gegevens"
>abstract="Wijs op welke ervaringsplaatsen **** of **uitgesloten** zouden moeten zijn wanneer het verzamelen van gegevens voor Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_locations_boldheader"
>title="Gegevensverzameling mobiele middelenlocaties"
>abstract="**plaatsen van Activa om te omvatten/uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_locations_header"
>title="Gegevensverzameling mobiele middelenlocaties"
>abstract="Wijs op welke activaplaatsen **** of **uitgesloten** zouden moeten zijn wanneer het verzamelen van gegevens voor Content Analytics."

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_urls_boldheader"
>title="URL&#39;s met gegevens over mobiele elementen"
>abstract="**Middel URLs om te omvatten/uit te sluiten**"

>[!CONTEXTUALHELP]
>id="aca_onboarding_datacollection_mobile_asset_urls_header"
>title="URL&#39;s met gegevens over mobiele elementen"
>abstract="Wijs op welke activa URLs **inbegrepen** of **** zou moeten zijn uitgesloten wanneer het verzamelen van gegevens voor Content Analytics."
