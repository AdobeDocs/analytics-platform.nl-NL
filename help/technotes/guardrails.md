...
| Rijen per verbinding per jaar | Varieert door toegewezen gegevenscentrum (zie beschrijving voor meer informatie) | Prestatiehandleiding | De aanbevolen rijlimiet per jaar in een verbinding. De onderstaande limieten zijn ongeveer vanaf januari 2026 en worden in de loop der tijd verhoogd om meer rijen per verbinding mogelijk te maken. Als u deze limieten wilt overschrijden, neemt u contact op met uw Adobe-accountteam om alternatieve configuraties te bespreken. <p>De rijlimiet varieert, afhankelijk van het toegewezen datacenter, als volgt:</p><ul><li>**VS Azure (gebrek voor de klanten van de V.S.)**: Ongeveer 500 miljard (ongeveer 42 miljard per maand)</li><li>**VS AWS (beschikbaar door verzoek voor klanten in de V.S.)**: Ongeveer 30 miljard (ongeveer 2.5 miljard per maand)</li><li>**Amsterdam**: Ongeveer 200 miljard (ongeveer 16.5 miljard per maand)</li><li>**Alle andere gegevenscentra**: 25 miljard (ongeveer 2 miljard per maand)</li></ul></p><p>Organisaties kiezen hun Experience Platform-datacenter bij de eerste aankoop van Experience Platform. Dit besluit is gewoonlijk gebaseerd op gegevenssoevereiniteit en ingezetenschapsvereisten. Bij het kiezen van een datacenter moet rekening worden gehouden met alle gebruiksgevallen van AEP+Apps (niet alleen rijvolumes in Customer Journey Analytics).</p><p>Voor informatie over hoe te om te bekijken welk gegevenscentrum u aan wordt toegewezen, zie [&#x200B; Customer Journey Analytics ontvangende plaatsen &#x200B;](/help/technotes/data-centers.md)</p> |
