...
# Customer Journey Analytics-hostinglocaties
...
>[!NOTE]
>
>Gegevens kunnen niet van het ene naar het andere datacenter worden verplaatst.
...
1. Gebruik de volgende tabel om te begrijpen met welk geografisch gebied uw regiocode is geassocieerd:
   ...
   | Adobe-regiocode | Cloud-provider | Geografisch gebied |
   |-------------------|-------|-------------------------------------------|
   | VA7 | Azure | VS (standaard) |
   | VA6 | AWS | VS (op verzoek) |
   | NLD2 | Azure | Nederland, Amsterdam |
   | CAN2 | Azure | Canada Central, Toronto |
   | AUS5 | Azure | Australië, Sydney |
   | GBR9 | Azure | VK, Londen |
   | IND2 | Azure | India |
   | CHE2 | Azure | Zwitserland |
