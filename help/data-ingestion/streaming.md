...
Om deze gegevens in de dataset te stromen die u creeerde, moet u een het stromen eindpunt voor die gegevens bepalen worden verzonden naar. Dit doet u door een HTTP API-bronconnector te definiëren.
