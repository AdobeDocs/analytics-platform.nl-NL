...
+ Gegevensspiegel {#cja-data-mirror}
   ...
   + [Data Mirror-handleiding voor snel starten](/help/data-mirror/relational.md)
...
+ Workspace-projecten {#cja-workspace}
   ...
   + Visualisaties {#visualizations}
      ...
      + Vrije-vormtabel {#freeform-table}
         ...
         + [Meerdere afmetingen opnemen](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
...
+ Stiksel {#stitching}
   ...
   + [Sstitching inschakelen](/help/stitching/use-stitching-ui.md)
...
+ Technische notities {#technotes}
   ...
   + [Browser en taal](/help/technotes/browser-language.md)
   ...
   + [Beveiligingsmechanismen](../technotes/guardrails.md)
