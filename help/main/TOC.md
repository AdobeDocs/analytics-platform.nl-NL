...
+ Onderdelen {#cja-components}
   ...
   + Filters {#cja-filters}
      ...
      + [Opeenvolgende filters maken](../components/filters/seg-sequential-build.md)
...
+ Adobe-integratie {#integrations}
   ...
   + [Doel integreren](/help/integrations/cja4t.md)
...
+ Gebruik hoofdletters {#cja-usecases}
   ...
   + Gepersonaliseerde inzichten en betrokkenheid {#personalized-insights-engagement}
      + [Overzicht](/help/use-cases/pie/overview.md)
      + [Optimalisatie van klantconversie](/help/use-cases/pie/customer-conversion-optimization.md)
