---
description: Factoren die van invloed zijn op de prestaties van Customer Journey Analytics en werkruimten en optimalisaties die u kunt maken
...
# Customer Journey Analytics optimaliseren en [!UICONTROL Analysis Workspace] prestaties

Verschillende factoren kunnen van invloed zijn op de algehele prestaties van de Customer Journey Analytics en op de prestaties van een project in Analysis Workspace. In Workspace krijgt u mogelijk een foutbericht met de volgende tekst:
...
| **Verbindingsgrootte** | De hoeveelheid gegevens die in uw Verbinding wordt verzameld. |  | Raadpleeg uw implementatieteam of Customer Journey Analytics-expert om te bepalen of er implementatieverbeteringen zijn die kunnen worden aangebracht om de algehele ervaring in Customer Journey Analytics te verbeteren. |
