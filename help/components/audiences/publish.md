---
title: Soorten publiek maken en publiceren
...
1. Voer een van de volgende handelingen uit om een publiek te maken en te publiceren:
   ...
   | --- | --- |
   | Vanuit de interface **[!UICONTROL Published audiences]** | Selecteer **[!UICONTROL Components]** > **[!UICONTROL Published audiences]** in het hoofdmenu van Customer Journey Analytics. De interface van het publiek toont. Selecteer **[!UICONTROL Create audience]** en [!UICONTROL Audience builder] wordt geopend. |
...
Houd rekening met het volgende wanneer u werkt met soorten publiek die van Customer Journey Analytics naar Experience Platform worden gepubliceerd:

* Het publiek in Experience Platform heeft dezelfde naam en beschrijving als het Customer Journey Analytics-publiek. De naam wordt met de gebruikers-id van Customer Journey Analytics toegevoegd om ervoor te zorgen dat het publiek uniek is.
