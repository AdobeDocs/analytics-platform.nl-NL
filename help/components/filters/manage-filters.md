...
| **[!UICONTROL Title and description]** | Om de filter uit te geven, selecteer de titelverbinding, die de [ bouwer van Filters ](filter-builder.md) opent. Een gedeeld filter wordt vermeld met ![ Aandeel ](/help/assets/icons/Share.svg). |
