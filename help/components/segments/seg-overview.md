...
- **Modulariteit**: Bepaal segmenten met modulariteit in mening. De gebruikers van uw segmenten zouden [ stapelsegmenten ](seg-builder.md#stack-filters) gemakkelijk moeten kunnen {maken om krachtige nieuwe segmenten tot stand te brengen.
