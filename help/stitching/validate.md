...
>[!IMPORTANT]
>
>Dit artikel beschrijft hoe te om het stitching te bevestigen die [&#x200B; door Adobe &#x200B;](/help/stitching/use-stitching.md) wordt gevraagd en gebruikend een gestikte identiteitskolom wordt uitgevoerd die aan een dubbele verbonden dataset wordt toegevoegd. Het artikel is gepland om spoedig met details op te worden bijgewerkt hoe te het stitching bevestigen dat [&#x200B; door de Verbindingen UI &#x200B;](/help/stitching/use-stitching-ui.md) wordt toegelaten.
