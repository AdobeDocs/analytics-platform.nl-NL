...
* Als u op grafiek-gebaseerde het stitching wilt gebruiken en u de gebeurtenisdataset om aan de Grafiek van de Identiteit vooruitloopt bij te dragen, zou u de dataset voor de dienst van de Identiteit [&#x200B; moeten toelaten. &#x200B;](/help/stitching/faq.md#enable-a-dataset-for-the-identity-service) Een dataset draagt bij aan de Grafiek van de Identiteit wanneer de dataset relevante persoon IDs naast blijvende IDs bevat.
...
Zodra u een verbinding opslaat, het stitching proces voor datasets die voor het stitching kiks worden toegelaten wanneer de opname van gegevens voor deze datasets begint
