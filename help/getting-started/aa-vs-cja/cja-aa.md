...
| **Voorspelling** | [Prognoses](/help/analysis-workspace/c-forecast/forecasting.md) zijn een AI/ML-mogelijkheid die een statistische voorspelling omvat voor tijdreeksgerelateerde gegevens op basis van de historische gegevens die al bestaan in Customer Journey Analytics. Prognoses kunnen worden weergegeven in vrije-vormtabellen en visualisaties van lijngrafieken. |
| **Begeleide analyse** | [Begeleide analyse](/help/guided-analysis/overview.md) stelt gebruikers in staat om zelf hoogwaardige gegevens en inzichten over het klanttraject te leveren via begeleide workflows, gebaseerd op de cross-channel gegevens van Customer Journey Analytics. |
| **Intelligente bijschriften** | Intelligente ondertiteling maakt gebruik van geavanceerde machine learning en generatieve AI om waardevolle inzichten in natuurlijke taal te bieden voor Workspace-visualisaties. De aanvankelijke versie verstrekt auto-geproduceerde inzichten voor de [ visualisatie van de Lijn ](/help/analysis-workspace/visualizations/line.md). |
...
| **Cijfers** | Volledige ondersteuning; Customer Journey Analytics maakt gebruik van het Experience Data Model (XDM) en ondersteunt onbeperkte metrische gegevens en is niet gebonden aan de aangepaste succesgebeurtenissen van Adobe Analytics. Sommige standaardstatistieken zijn hernoemd van Adobe Analytics: Bezoekers = Mensen, Bezoeken = Sessies, Hits = Evenementen. |
| **Projecten, filters en berekende metrische gegevens migreren van Adobe Analytics naar Customer Journey Analytics** | Volledige ondersteuning. |
| **Mobiele scorekaart/dashboards** | Volledige ondersteuning |
...
| **Publiek publiceren** | Wordt ondersteund als de Adobe een licentie heeft voor Customer Data Platform of Journey Optimizer-producten. [Audience Publishing](/help/components/audiences/audiences-overview.md) stuurt doelgroepen naar Real-time Customer Profile in Experience Platform. |
...
| **Klantkenmerken** | Ze worden nu &quot;Profielgegevenssets&quot; genoemd en worden niet automatisch geïmporteerd uit Experience Cloud, maar moeten worden geüpload naar Experience Platform voordat ze beschikbaar zijn in Customer Journey Analytics. |
| **Gegevens feeds** | Gegevensexport van de eerste generatie van gegevenssets is beschikbaar via de [Experience Platform Data Access API](https://experienceleague.adobe.com/docs/experience-platform/data-access/api.html) en via [Experience Platform Destinations](https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/activate/export-datasets.html). Deze opties bieden export op gebeurtenis-/rijniveau van alle gegevens die zijn verzameld of opgenomen in Experience Platform Data Lake. Gegevenskolommen na verwerking zijn niet beschikbaar omdat berichtkolommen worden berekend op het moment van de query. Export van berichtkolommen is beschikbaar via rapportage. |
| **Data Warehouse rapportage** | [ de Volledige Uitvoer van de Lijst van de Customer Journey Analytics ](/help/analysis-workspace/export/export-cloud.md) is de evolutie van de rapporten van de Data Warehouse in Adobe Analytics, met vele nieuwe, vaak-gevraagde eigenschappen die niet vandaag in Data Warehouse beschikbaar zijn. |
...
| **dwars-apparaat/dwars-kanaal het stitching** | Ondersteund voor gebeurtenisgegevenssets die identiteitsgegevens bevatten. Zie [Stikken](../../stitching/overview.md). |
...
| **malplaatjes van het Project** | Ondersteuning is gepland. |
| **Real-time rapportage** | Ondersteuning is gepland. |
