...
| Omrekening in valuta | Ondersteund als onderdeel van [het formatteren van een metrische component](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/format.html?lang=en#currency) in een gegevensweergave. |
