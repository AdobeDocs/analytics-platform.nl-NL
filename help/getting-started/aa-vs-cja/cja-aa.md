...
| GDPR-verwijdering | volledige ondersteuning; merkt op dat GDPR nu wordt behandeld in coördinatie met [!UICONTROL Adobe Experience Platform]. Customer Journey Analytics neemt alle gegevenswijzigingen over [!UICONTROL Experience Platform] maakt aan onderliggende datasets. |
...
| Metrics | volledige ondersteuning; Customer Journey Analytics gebruikt het Model van de Gegevens van de Ervaring (XDM) en steunt onbeperkte metriek en is niet verbonden aan de gebeurtenissen van het douanesucces van Adobe Analytics. De naam van sommige standaardmetriek is gewijzigd in Adobe Analytics: Bezoekers = Personen, Bezoeken = Sessies, Hits = Gebeurtenissen. |
...
| Tijdverwerking rapporteren | volledige ondersteuning; Customer Journey Analytics vertrouwt uitsluitend op de Tijdverwerking van het Rapport. |
| API-toegang rapporteren | volledige ondersteuning; Beschikbaar via [Customer Journey Analytics API](https://developer.adobe.com/cja-apis/docs/). |
...
| IP Obfuscatie | Voor Customer Journey Analytics-klanten die de Analytics Source Connector gebruiken om gegevens van Adobe Analytics in Customer Journey Analytics te vullen: De IP die montages in Adobe Analytics worden toegepast stromen door aan uw Customer Journey Analytics gegevens. U kunt deze instellingen desgewenst in Adobe Analytics beheren.<p>Voor Customer Journey Analytics klanten die SDK van het Web van het Experience Platform gebruiken om gegevens in Platform en Customer Journey Analytics direct te bevolken. U kunt Prep van Gegevens voor de Inzameling van Gegevens in Platform gebruiken om regels te vormen die het IP adres verduisteren dat op de vereisten van uw bedrijf wordt gebaseerd. |
...
| Onbeperkte Dimension en cijfers van klanten | Customer Journey Analytics-afmetingen zijn onbeperkt; waarden kunnen numeriek, tekst, objecten, lijsten of mengsels van allemaal zijn. Dimension kunnen genest of hiërarchisch zijn. Analytics ondersteunt maximaal 75 props en 250 eVars. |
...
| Tijdtransformaties rapporteren | De Transformaties van de Tijd van het rapport (beter gekend als de Mening van Gegevens) in Customer Journey Analytics staat u toe om gegevens van een verbinding verder te interpreteren. U kunt gegevens wijzigen of verwijderen zonder deze opnieuw te implementeren. subtekenreeksen gebruiken om afmetingen te manipuleren; metriek van om het even welke waarde tot stand brengen; filterhulpstoffen. Transformatie wordt allemaal niet-destructief uitgevoerd. Adobe Analytics biedt beperkte mogelijkheden door middel van virtuele rapportsuites en sessionisatie. |
