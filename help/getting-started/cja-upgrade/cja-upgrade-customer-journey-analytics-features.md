...
>title="Het stitching voor één of meerdere datasets toestaan"
>abstract="Als u een gebied hebt dat een herkenningsteken bevat dat in veelvoudige datasets bestaat maar niet het primaire herkenningsteken is, kunt u het stitching gebruiken om de gegevens in één of meerdere van deze datasets op te heffen."
