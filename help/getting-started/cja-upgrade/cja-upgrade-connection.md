...
1. Configureer de verbindingsinstellingen
   ...
   | **[!UICONTROL Backfill data]** | U kunt verzoeken om een back-up te maken van de gegevens in een gegevensset. U kunt bijvoorbeeld een verzoek indienen om een back-up te maken van de gegevens van de laatste 7 dagen. Configureer de dataset correct en test uw verbinding. Als alles er goed uitziet, kunt u eenvoudig back-ups maken van alle resterende gegevens.<p>Bovendien kunt u de invoer van nieuwe gegevens door dataset toelaten. |
...
1. Nu, vorm de datasets één voor één.
   ...
   | **[!UICONTROL Key]** | Alleen beschikbaar voor opzoekgegevenssets. De sleutel die voor een dataset Lookup moet worden gebruikt. |
   ...
   | **[!UICONTROL Description]** | De beschrijving die aan deze dataset is gegeven toen het werd gecreeerd. |
