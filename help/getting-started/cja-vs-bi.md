...
* **handelt als een headless oplossing van BI**: U bepaalt uw dimensies, metriek, filters in één plaats, en dan kan om het even welke cliënt van Customer Journey Analytics (met inbegrip van onze openbare Customer Journey Analytics API) tot die componenten toegang hebben. Dit onttrekt complexe vragen weg van eind - gebruikers en waarborgt dat de resultaten het zelfde zijn, geen kwestie die rapporteert of visualisatieclient u gebruikt.
