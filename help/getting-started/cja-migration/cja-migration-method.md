...
Gebruik de volgende secties om te bepalen welke de migratiemethode van de Customer Journey Analytics het best zich op de huidige implementatie en toekomstige doelstellingen van uw organisatie richt:
...
Gebruik het volgende diagram om te helpen visualiseren waar elke migratiemethode op het spectrum in termen van inspanningsniveau valt, evenals de levensvatbaarheid op lange termijn die elk bereikt:
...
Gebruik de onderstaande informatie als algemene richtlijnen om u te helpen begrijpen welke migratiemethode het meest geschikt is voor uw organisatie.
...
### AppMeasurement- en Adobe Analytics-extensie
