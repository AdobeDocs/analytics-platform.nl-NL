...
Wanneer u dit migratiepad kiest, moet u ook uw schema kiezen.
...
Als u de migratieweg koos die u toestaat om de implementatie van SDK van het Web van Adobe Analytics te vormen om gegevens naar Customer Journey Analytics te verzenden, kunt u het schema kiezen dat u wilt gebruiken.
