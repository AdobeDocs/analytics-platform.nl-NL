...
| **Zoeken naar Edge Network** | Schakel automatische gegevensverzameling van apparaattypen in via de Edge Network Experience Platform. Deze service biedt voordelen voor Customer Journey Analytics samen met andere Experience Platform-apps. [Meer informatie](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | N.v.t. | donderdag 27 september 2023 |
