...
| ----------- | ---------- | ------- | ---- |
| **Updates aan de interface van het Gebruik** | De [ interface van het Gebruik ](/help/connections/manage-connections.md#usage) voegt nu informatie over kerngegevensvolume en gemiddelde rijgrootte toe. | | vrijdag 4 september 2025 |
