...
| ----------- | ---------- | ------- | ---- |
| **Hoog treedt met voeten kopbal** | U kunt in Content Analytics een naam voor de koptekst en een geheime koptekstwaarde opgeven.  Deze [&#x200B; kopbal treedt configuratie &#x200B;](/help/content-analytics/config/guided.md#header-overrides) met voeten ervoor dat Content Analytics de kopballen van douaneHTTP verzendt om om het even welke bot opsporing of de technologieën van het toegangsverkeer te mijden u hebt uitgevoerd. |  | dinsdag 2 februari 2026 |
