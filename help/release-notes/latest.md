...
| **Steun voor Veilige Doelen in Report Builder** | Er zijn nieuwe exportdoelen toegevoegd aan de Report Builder-add-in. De volgende bestemmingen voor cloudopslag worden ondersteund: <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> (Koppeling naar documentatie) |  | 19 juni 2025 (oorspronkelijk 18 juni 2025) |
