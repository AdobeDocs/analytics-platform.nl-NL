...
| **Inhoudsopgave voor werkruimteprojecten** | Er is nu een nieuwe inhoudsopgave beschikbaar voor projecten. De inhoudsopgave bevat koppelingen waarmee gebruikers snel naar deelvensters en visualisaties in het project kunnen gaan. <p>De inhoudsopgave kan worden ingeschakeld voor afzonderlijke projecten of voor alle projecten voor een bepaalde gebruiker.</p><p>(Koppeling met documentatie die moet worden gevolgd.)<!--For more information, see "Display the project table of contents" in "Create projects".--> |  | donderdag 19 juni 2024 |
