...
| ----------- | ---------- | ------- | ---- |
| **Adobe Product Analytics** | Een nieuw projecttype dat productteams toestaat om hun gegevensbehoeften snel zelf-te dienen zodat zij meer gegeven-gedreven productbesluiten kunnen nemen. Deze is gebaseerd op de bestaande workflows voor verbinding en gegevensweergave in Customer Journey Analytics. Er zijn geen implementatie- of configuratiewijzigingen nodig. [Meer informatie](/help/guided-analysis/overview.md)<p>Product Analytics is een betaalde aanvulling op Customer Journey Analytics. Neem contact op met het accountteam van uw Adobe als uw organisatie deze functie wil gebruiken. | N.v.t. | 17 juli 2023 |
