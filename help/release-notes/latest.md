...
# Huidige Adobe Customer Journey Analytics-releaseopmerkingen (september 2025)
...
| **de toetsengrens van de Raadpleging steeg tot 1 miljard** | Het maximumaantal unieke sleutels voor een raadplegingsdataset is nu tot 1 miljard, afhankelijk van uw Customer Journey Analytics recht. <p>Eerder was het maximumaantal 10 miljoen voor alle toeslagrechten.<p>Voor meer informatie, zie [ Guardrails ](/help/technotes/guardrails.md).</p> | | vrijdag 18 september 2025 |
| **Steun voor ad hoc schema&#39;s** | [ Ad hoc schema&#39;s ](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/tutorials/ad-hoc) worden gebruikt in diverse werkschema&#39;s van de gegevensopname voor Experience Platform, met inbegrip van het opnemen van CSV- dossiers en het creëren van bepaalde soorten bronverbindingen. <p>Met deze functie wordt ondersteuning geboden voor het gebruik van ad-hocschema&#39;s in Customer Journey Analytics. Als deel van de definitie van een verbinding, kunt u nu een dataset selecteren die op een ad hoc schema wordt gebaseerd en de gegevens in uw gegevensmening en werkruimteprojecten gebruiken.</p> <p>(Koppeling met documentatie die moet worden gevolgd.)</p> |  | 23 september 2025 (oorspronkelijk gepland voor vrijgave op 28 augustus 2025) |
| **Echt - tijd rapporterend** | [ Real-time het melden in Customer Journey Analytics ](/help/components/real-time/real-time.md) toont en werkt gegevens en visualisaties binnen één of meerdere panelen in Analysis Workspace in real time bij.<br/> | 18 september 2025 (oorspronkelijk gepland voor vrijgave op 15 augustus 2025) | 25 september 2025 |
| **Steun voor gegevensspiegel** | Met steun voor model-gebaseerde schema&#39;s en de functionaliteit van de vangst van veranderingsgegevens (CDC) voor specifieke bronschakelaars in Experience Platform, zal Customer Journey Analytics de functionaliteit van de gegevensspiegel van gegevensopslagoplossingen voor Snowflake, Databricks en Google BigQuery kunnen steunen. <p>Neem contact op met uw Adobe-accountteam voor toegang tot de bètaversie.</p><p>(Koppeling met documentatie die moet worden gevolgd.)</p> | Beta-release van 24 september | TBD |
