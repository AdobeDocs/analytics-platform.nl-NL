...
| ----------- | ---------- | ------- | ---- |
| **dimensie van de Diepte van de Gebeurtenis** | Een nieuwe dimensie van de Diepte van de Gebeurtenis wordt toegevoegd aan de lijst van [ vereiste standaardcomponenten ](/help/data-views/component-reference.md#required-standard-components) voor een gegevensmening. |  | vrijdag 8 mei 2025 |
