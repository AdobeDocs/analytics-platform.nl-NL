...
| ----------- | ---------- | ------- | ---- |
| **dimensie van de Diepte van de Gebeurtenis** | Een nieuwe dimensie van de Diepte van de Gebeurtenis wordt toegevoegd aan de lijst van [ standaardafmetingen ](/help/components/dimensions/overview.md#standard-dimensions) voor een gegevensmening. |  | vrijdag 8 mei 2025 |
| **Verhoging in volledige lijst de uitvoergrenzen van de lijst** | Het aantal kolommen u met volledige lijstuitvoer kunt gebruiken wordt verhoogd van 5 dimensies en 5 metriek aan 10 dimensies en 10 metriek. Deze verhoging geldt voor alle Customer Journey Analytics-lagen. De rechten voor het aantal rijen dat kan worden geëxporteerd, worden niet gewijzigd. |  | donderdag 30 april 2025 |
