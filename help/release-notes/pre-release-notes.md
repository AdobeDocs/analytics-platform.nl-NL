---
title: Opmerkingen bij de release Customer Journey Analytics
description: Bekijk de nieuwste Customer Journey Analytics-opmerkingen voor de release
...
# Opmerkingen bij de release Adobe Customer Journey Analytics
...
Deze opmerkingen hebben betrekking op de releaseperiode van 2 juni 2025 tot 15 juli 2025. De versies van Adobe Customer Journey Analytics werken op a [ ononderbroken leveringsmodel ](releases.md), dat voor een scalable, gefaseerde benadering van eigenschapplaatsing toestaat.

Raadpleeg de volgende documentatie voor opmerkingen bij de release van Adobe Experience Platform en de andere toepassingen ervan:

* [ Adobe Experience Platform ](https://experienceleague.adobe.com/nl/docs/experience-platform/release-notes/pre-release-notes)
* [Adobe Journey Optimizer](https://experienceleague.adobe.com/nl/docs/journey-optimizer/using/whats-new/release-notes?lang=en)
* [Adobe Journey Optimizer B2B](https://experienceleague.adobe.com/nl/docs/journey-optimizer-b2b/user/release-notes?lang=en)
* [Samenstelling van Federated-doelgroep](https://experienceleague.adobe.com/nl/docs/federated-audience-composition/using/release-notes?lang=en)
* [Real-Time CDP Collaboration](https://experienceleague.adobe.com/nl/docs/real-time-cdp-collaboration/using/latest?lang=en)
...
| **Steun voor Veilige Doelen in Report Builder** | Er zijn nieuwe exportdoelen toegevoegd aan de Report Builder-add-in. De volgende bestemmingen voor cloudopslag worden ondersteund: <ul><li>AEP Data Landing Zone</li><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> |  | Juni 18,2025 |
| **Nieuwe voorproefervaring** | Het voorvertoningsvenster, dat wordt gebruikt voor het voorvertonen van segmenten, berekende metriek en meer, gebruikt nu een horizontale streekvisualisatie in plaats van een donutvisualisatie. |  | donderdag 18 juni 2025 |
...
| **kaart van de Verbinding** | Een nieuwe [ interface van de verbindingskaart ](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-connections/create-connection#connection-map) is beschikbaar om uw verbindingsconfiguratie visueel te tonen. |  | donderdag 18 juni 2025 |
