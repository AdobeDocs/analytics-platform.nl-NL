...
U kunt het gebruikersinterface van de Dienst van de Vraag [&#128279;](https://experienceleague.adobe.com/nl/docs/experience-platform/query/ui/overview) gebruiken, a [ cliënt die door het protocol PostgresQL ](https://experienceleague.adobe.com/nl/docs/experience-platform/query/clients/overview) wordt aangesloten, of [ RESTful APIs ](https://experienceleague.adobe.com/nl/docs/experience-platform/query/api/getting-started) om vragen tot stand te brengen en te plannen die de gegevens voor uw gegevensvoer verzamelen.

### Query maken

U kunt alle functionaliteit van standaardANSI SQL voor UITGEZOCHTE verklaringen en andere beperkte bevelen gebruiken om vragen tot stand te brengen en uit te voeren die de gegevens voor uw gegevensvoer produceren. Zie [ SQL syntaxis ](https://experienceleague.adobe.com/nl/docs/experience-platform/query/sql/syntax) voor meer informatie. Buiten deze SQL-syntaxis ondersteunt Adobe:

- prebuilt [ Adobe-bepaalde functies (ADF) ](https://experienceleague.adobe.com/nl/docs/experience-platform/query/sql/adobe-defined-functions) die helpen gemeenschappelijke zaken-gerelateerde taken op gebeurtenisgegevens uitvoeren die in het meer van de Experience Platform gegevens, met inbegrip van functies voor [ Sessionisatie ](https://experienceleague.adobe.com/nl/docs/analytics/components/virtual-report-suites/vrs-mobile-visit-processing) en [ Attributie ](https://experienceleague.adobe.com/nl/docs/analytics/analyze/analysis-workspace/attribution/overview) worden opgeslagen,
...
Zie [ identiteitsgebieden in UI ](https://experienceleague.adobe.com/nl/docs/experience-platform/xdm/ui/fields/identity) voor meer informatie bepalen over hoe te om identiteitsgebieden in Experience Platform te bepalen.
