...
In dit artikel wordt beschreven hoe u een aantal gebruiksgevallen (15) kunt uitvoeren met de Customer Journey Analytics BI-extensie. In elke gebruikszaak wordt de Customer Journey Analytics-functionaliteit beschreven, gevolgd door details voor elk van de ondersteunde BI-gereedschappen:
...
* **verbind**
   * [Weergaven van Connect- en lijstgegevens](bi-extension/connect-and-validate.md)

* **Rapport en analyseer**
   * [Dagelijkse trend](bi-extension/daily-trend.md)
   * [Uurtrend](bi-extension/hourly-trend.md)
   * [Maandelijkse trend](bi-extension/monthly-trend.md)
   * [Eén dimensie, gerangschikt](bi-extension/single-dimension-ranked.md)
   * [Meerdere dimensies gerangschikt](bi-extension/multiple-dimension-ranked.md)
   * [Waarden voor verschillende dimensies tellen](bi-extension/count-distinct-dimension-values.md)
   * [Namen van datumbereik gebruiken om te filteren](bi-extension/use-date-range-names-to-filter.md)
   * [Segmentnamen gebruiken](bi-extension/use-segment-names-to-segment.md)
   * [Dimensiewaarden gebruiken om te segmenteren](bi-extension/use-dimension-values-to-segment.md)
   * [Sorteren](bi-extension/sort.md)
   * [Limieten](bi-extension/limits.md)

* **Begrijp**

   * [Transformaties](bi-extension/transformations.md)
   * [Visualisaties](bi-extension/visualizations.md)
...
Power BI Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/nl/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Credentials guide](https://experienceleague.adobe.com/nl/docs/experience-platform/query/ui/credentials)
* [Connect Power BI to Query Service](https://experienceleague.adobe.com/nl/docs/experience-platform/query/clients/power-bi).
...
Tableau Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/nl/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Prerequisites](/help/data-views/bi-extension.md#prerequisites)
* [Credentials guide](https://experienceleague.adobe.com/nl/docs/experience-platform/query/ui/credentials)
* [Connect Tableau Desktop to Query Service](https://experienceleague.adobe.com/nl/docs/experience-platform/query/clients/tableau).
...
Looker supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/nl/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
Jupyter Notebook supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/nl/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
RStudio supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/nl/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
