...
1. In het dialoogvenster **[!UICONTROL Navigator]** worden de gegevensweergaven opgehaald. Dit kan enige tijd duren. Na ophalen:
   ...
   1. Selecteer **[!UICONTROL public.ares_sql_validation]** in de lijst in het linkerdeelvenster.
...
1. In het hoofdvenster ziet u in de weergave Data Source in het linkervenster:
   ...
   * Een lijst met tabellen, onder **[!UICONTROL Table]** .
   ...
   1. Sleep het item **[!UICONTROL ares_sql_validation]** en zet het neer in de hoofdweergave die **[!UICONTROL Drag tables]** hier leest.
1. In het hoofdvenster worden nu de details van de gegevensweergave van **[!UICONTROL ares_sql_validation]** weergegeven.
...
1. In het deelvenster **[!UICONTROL Visualizations]** :
   ...
   ![ Geval van het Gebruik van de Desktop 2 van de Datum waaierfilter ](assets/uc2-pbi-filter-daterange.png)
...
1. Zorg ervoor dat het **[!UICONTROL Data]** -werkblad is geselecteerd. In de weergave Gegevens:
   ...
   1. Wijzig **[!UICONTROL Standard]** in **[!UICONTROL Entire View]** in het vervolgkeuzemenu in de werkbalk.
      ...
      De weergave **[!UICONTROL Day]** ziet er hieronder ongeveer zo uit.

      ![ Gegevens van de Desktop van Tableau ](assets/uc2-tableau-data.png)

1. Selecteer de tab **[!UICONTROL Dashboard]** om een nieuwe **[!UICONTROL Dashboard 1]** -weergave te maken. In de weergave **[!UICONTROL Dashboard 1]** :
