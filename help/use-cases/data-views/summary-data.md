...
1. Selecteer **[!UICONTROL Add field groups]** in het dialoogvenster **[!UICONTROL Create new field group]** .
...
1. Selecteer **[!UICONTROL Datasets]** in het scherm **[!UICONTROL Create datasets]** > **[!UICONTROL Create dataset from schema]** .
...
In **[!UICONTROL Sources]** > **[!UICONTROL Dataflow - XX/XX/XXXX, XX:XXXX]** wordt de status van de upload weergegeven. Vernieuw om updates van de upload te zien. Wanneer dit lukt, worden de voorbeeldgegevens geladen in Experience Platform.
