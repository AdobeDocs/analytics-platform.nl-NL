...
>[!NOTE]
>
>[&#x200B; Standaard componenten &#x200B;](../component-reference.md) zijn gebonden aan en verbonden aan gebeurtenisdatasets. Dientengevolge, werken de standaardcomponenten die als deel van een afgeleid gebied slechts tegen gegevens van een gebeurtenisdataset worden gebruikt.
>
...
De standaardcomponenten worden slechts gesteund op gebeurtenisdatasets in afgeleide gebieden.
...
### Statusbreedte {#state-latitude}

Deze functiesjabloon haalt de breedtegraad voor een Amerikaanse staat met een precisie van 5 cijfers.
...
![&#x200B; Screenshot van de de regelbouwer van de Latitude van de Staat &#x200B;](assets/function-template-state-latitude.png)

+++


### Lengtegraad status {#state-longitude}

Deze functiesjabloon haalt de lengtegraad voor een Amerikaanse staat op met een precisie van 5 cijfers.
...
![&#x200B; Scherenshot van de de regelbouwer van de Longitude van de Staat &#x200B;](assets/function-template-state-longitude.png)
...
Customer Journey Analytics gebruikt een genestelde containerstructuur, gemodelleerd na Adobe Experience Platform [&#x200B; XDM &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/xdm/home.html?lang=nl) (het Model van Gegevens van de Ervaring). Zie [&#x200B; Containers &#x200B;](../create-dataview.md#containers) en [&#x200B; de containers van het Segment &#x200B;](/help/components/segments/seg-overview.md#containers) voor meer achtergrondinformatie. Dit containermodel, zij het flexibel door aard, legt sommige beperkingen op wanneer het gebruiken van de regelbouwer.
...
>title="Datumwiskunde"
>abstract="Deze functie biedt de mogelijkheid om het verschil tussen twee datum- of datum-tijdvelden te retourneren. Op personen gebaseerde velden (van profielgegevenssets) hebben geen opties voor **[!UICONTROL Return the first]** en **[!UICONTROL Return the last.]** ."
...
U kunt ook de gebruiksvriendelijke waarde Dynamisch datumbereik nu gebruiken om tussen nu en [!UICONTROL Local Time] te berekenen (vanuit uw [!UICONTROL placeContext] -veldgroep van uw gebeurtenisdataset)

![&#x200B; Schermafbeelding van de Datum Math regel 2a &#x200B;](assets/datemath-2a.png)
...
## Meer informatie {#datemath-more-info}

De opties voor [!UICONTROL Return the first] of [!UICONTROL Return the last] zijn niet beschikbaar wanneer u een op personen gebaseerd veld (van een profielgegevensset) selecteert. Een op een persoon gebaseerd veld kan slechts één waarde hebben voor een datum- of datum-tijdveld voor een persoon.
+++
...
U wilt de interne zoekdiepte begrijpen (die u ook kunt interpreteren als het aantal zoekopdrachten). Zo kunt u die interne onderzoeksdiepte later gebruiken om op de onderzoekstermijn te breken verbonden aan een specifieke onderzoeksdiepte.


### Afgeleid veld {#depth-uc1-derivedfield}

U definieert een nieuw `Internal Search Depth` afgeleid veld. U gebruikt de functie [!UICONTROL DEPTH] om een regel te bepalen om de diepte van [!UICONTROL Internal Search Term] terug te winnen en dat op een nieuw afgeleid gebied op te slaan.

![&#x200B; Schermafbeelding van de regel van de Diepte &#x200B;](assets/depth-1.png)

En gebruik dan dat nieuwe afgeleide gebied in een visualisatie om op te delen welke termijn aan onderzoek naar bij het eerste onderzoek is gebruikt.

![&#x200B; Schermafbeelding van de regel van de Diepte &#x200B;](assets/depth-1a.png)
...
| Gegevenstype invoer | Invoer | Opgenomen operatoren | Limiet | Uitvoer |
|---|---|---|---|---|
| <ul><li>String</li><li>Numeriek</li></ul> | <ul><li>[!UICONTROL Field]:</li><ul><li>Regels</li><li>Standaardvelden</li><li>Velden</li></ul></ul><ul><li>[!UICONTROL Method]:</li><ul><li>Van links</li><li>Van rechts</li><li>Omzetten in array</li></ul></li><li>Voor scheidingsteken:<ul><li>String</li></ul><li>Voor index:<ul><li>Numeriek</li></ul></li> | <p>N.v.t.</p> | <p>2 functies per afgeleid veld</p> <p>Retourneert maximaal 10 waarden</p> | <p>Nieuw afgeleid veld</p> |
...
Hiermee wijzigt u het veldtype van een veld zodat dit beschikbaar is voor extra transformaties in Customer Journey Analytics.
...
| Gegevenstype invoer | Invoer | Opgenomen operatoren | Limiet | Uitvoer |
|---|---|---|---|---|
| <ul><li>Numeriek</li><li>Datum</li><li>Datum/tijd</li><li>String</li></ul> | <ul><li>[!UICONTROL Field] | <p><ul><li>Geheel<ul><li>Naar tekenreeks</li></ul></li><li>Dubbel<ul><li>Naar tekenreeks<ul><li>Inclusief aantal decimalen dat moet worden overgeërfd (max. 5?)</li></ul></li><li>Naar geheel getal</li></ul></li><li>Byte<ul><li>Naar tekenreeks</li></ul></li><li>Lang<ul><li>Naar tekenreeks</li></ul></li><li>Datum<ul><li>Naar tekenreeks<ul><li>Biedt de mogelijkheid om de uitvoerindeling te definiëren</li></ul></li><li>Voorbeelden<ul><li>Datum (voorbeeld 7 januari 2025)<ul><li data-stringify-indent="1" data-stringify-border="0">DD-MM-YY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 01-07-25</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">DD-MM-YYYY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 01-07-2025</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">DD-MM-YY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 07-01-25</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">DD-MM-YYYY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 07-01-2025</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">YY-MM-DD<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 25-01-07</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">YYYY-MM-DD<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 2025-01-07</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">MM/DD/YY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 07-01-25</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">MM/DD/YYYY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 07-01-2025</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">YYYY/MM/DD<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 01-2025-07</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">YY/MM/DD<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. 01-25-07</li></ul></li><li data-stringify-indent="1" data-stringify-border="0">DD MMM YYYY<ul><li data-stringify-indent="2" data-stringify-border="0">Voorbeeld. woensdag 7 januari 2025</li></ul></li></ul></li></ul></li></ul></li><li>Datum/tijd<ul><li>Naar tekenreeks<ul><li>Biedt de mogelijkheid om de uitvoerindeling te definiëren</li></ul></li><li>Voorbeelden<ul><li data-stringify-indent="0" data-stringify-border="0">Datum-tijd (Voorbeeld van 7 Januari, 2025 bij 1 :30pm, 52 seconden)<ul><li data-stringify-indent="2" data-stringify-border="0">DD-MM-YY hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 01-07-25 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">DD-MM-YYYY hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 01-07-2025 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">DD-MM-YY hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 07-01-25 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">DD-MM-YYYY hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 07-01-2025 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">YY-MM-DD hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 25-01-07 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">YYYY-MM-DD hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 2025-01-07 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">MM/DD/YY ummss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 01/07/25 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">DD-MM-YYYY ummss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 01/07/2025 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">YYYY/MM/DD uumss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 2025/01/07 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">YY/MM/DD hh:mm :ss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. 25/01/07 13 :30: 52</li></ul></li><li data-stringify-indent="2" data-stringify-border="0">MMM DD, YYYY hmss<ul><li data-stringify-indent="3" data-stringify-border="0">Voorbeeld. Januari 07, 2025 13 :30: 52</li></ul></li></ul></li></ul></li><li>String<ul><li>Naar numeriek<ul><li>Als we waarden hebben die niet numeriek van aard zijn, zullen ze null retourneren.</li><li>De gebruiker moet de precisie en de landinstelling invoeren die moet worden gebruikt. </li></ul></li></ul></li></ul></li></ul></p> | <p>3 functies per afgeleid veld</p> | <p>Nieuw afgeleid veld</p> |
...
| <p>Samenvoegen</p> | <ul><li>2 Samengevoegde functies per afgeleid veld</li><li>3 waarden per samengevoegde functie</ul> |
| <p>Datumwiskunde</p> | <ul><li>2 Datumwiskundige functies per afgeleid veld</li></ul> |
| <p>Dedupliceren</p> | <ul><li>5 Deduplicatiefuncties per afgeleid veld</li></ul> |
| <p>Diepte</p> | <ul><li>3 Dieptefunctie per afgeleid veld</li></ul> |
...
| <p>Splitsen</p> | <ul><li>2 splitsingsfuncties per afgeleid veld</li><li>Maximaal 10 waarden worden geretourneerd</ul> |
...
| <p>Typecast</p> | <ul><li>3 Typecast-functies per afgeleid veld</li></ul> |
