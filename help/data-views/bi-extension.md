...
1. Creeer [&#x200B; niet-vervallende geloofsbrieven in Experience Platform &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/query/ui/credentials#non-expiring-credentials). Als u reeds bestaande niet-vervallende geloofsbrieven wilt gebruiken, zorg ervoor deze geloofsbrieven [&#x200B; aan OAuth &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/query/ui/credentials#migrate-credentials) gemigreerd zijn.
...
1. In Power BI:
   ...
   1. In **krijgt het 1&rbrace; scherm van Gegevens &lbrace;, onderzoek naar** en selecteer het `PostgresSQL` gegevensbestand PostgresSQL **[!UICONTROL **&#x200B; van de lijst.**]**
