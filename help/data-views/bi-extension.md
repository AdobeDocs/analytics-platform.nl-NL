...
1. Creeer [ niet-vervallende geloofsbrieven in Experience Platform ](https://experienceleague.adobe.com/en/docs/experience-platform/query/ui/credentials#non-expiring-credentials). Als u reeds bestaande niet-vervallende geloofsbrieven wilt gebruiken, zorg ervoor deze geloofsbrieven [ aan OAuth ](https://experienceleague.adobe.com/en/docs/experience-platform/query/ui/credentials#migrate-credentials) gemigreerd zijn.

1. Zorg ervoor dat de niet-vervallende referentie beschikbaar is voor het Customer Journey Analytics-product en de productprofielen. U moet systeembeheerder voor de organisatie zijn om de volgende stappen uit te voeren.
   1. Selecteer **[!UICONTROL Admin Console]** van ![ App ](/help/assets/icons/Apps.svg).
   1. Controleer of de niet-vervallende referentie is toegevoegd aan de lijst met API-referenties.
      1. Selecteer **[!UICONTROL Users]** in het bovenste menu.
      1. Selecteer **[!UICONTROL API credentials]** in het linkerspoor.
      1. De nieuwe of gemigreerde niet-vervallende referenties moeten worden vermeld en beginnen met **[!UICONTROL EQS-...]** .

      1. Zorg ervoor dat de niet-vervallende API-referentie toegang heeft tot het Customer Journey Analytics-product en -profielen.

         1. Selecteer ![ ProductDetails ](/help/assets/icons/ProductDetails.svg) voor de **[!UICONTROL EQS-...]** niet-vervallende API referentie.
         1. Van de **[!UICONTROL EQS-...]** ruit van de productdetails, uitgezochte ![ Meer ](/help/assets/icons/More.svg) en selecteert **[!UICONTROL Edit API credentials]**.
         1. In het dialoogvenster **[!UICONTROL Edit API credentials]** valideert u de **[!UICONTROL Assigned profiles]** . Als er geen Customer Journey Analytics-product wordt vermeld:
            1. Selecteer ![ toevoegen ](/help/assets/icons/Add.svg) en selecteren **[!UICONTROL Customer Journey Analytics]**.
            1. Selecteer één of meerdere productprofielen die de gebruikers bevatten die u toegang tot voor de Dienst van de Vraag en de uitbreiding wilt verlenen BI.
            1. Selecteer **[!UICONTROL Apply]**.

1. Valideer dat de niet-vervallende API-referentie wordt weergegeven in de Experience Platform Query Service.

   1. Selecteer **[!UICONTROL Experience Platform]** van ![ App ](/help/assets/icons/Apps.svg).
   1. Selecteer **[!UICONTROL Queries]** in het linkerspoor.
   1. Selecteer **[!UICONTROL Credentials]** in het bovenste menu.
   1. De API-referentie die niet vervalt, wordt weergegeven met de naam die u hebt opgegeven in stap 1 in de lijst **[!UICONTROL Non-expiring credentials]** .
...
1. In Power BI:
   ...
   1. In **krijgt het 1} scherm van Gegevens {, onderzoek naar** en selecteer het `PostgresSQL` gegevensbestand PostgresSQL **[!UICONTROL ** van de lijst.**]**

   1. In het **[!UICONTROL ** PostgressSQL- gegevensbestand **]** dialoog:

      1. Plak de **[!UICONTROL ** parameter van de Gastheer **]** van de Vragen van Experience Platform [!UICONTROL Credentials] op het **[!UICONTROL ** de tekstgebied van de Server **]**.

      1. Plak de **[!UICONTROL ** parameter van het Gegevensbestand **]** {van de Vragen van Experience Platform [!UICONTROL Credentials] in het **[!UICONTROL ** 4} tekstgebied van het Gegevensbestand {.**]**

         Voeg `?FLATTEN` aan de **[!UICONTROL ** 2} parameter van het Gegevensbestand {toe, zodat leest het als **]** bijvoorbeeld. `prod:cja?FLATTEN` Zie [ genestelde gegevensstructuren voor gebruik met de hulpmiddelen van derdeBI ](https://experienceleague.adobe.com/en/docs/experience-platform/query/key-concepts/flatten-nested-data) voor meer informatie afvlakken.
...
1. In Tableau Desktop:
   ...
   1. In het dialoogvenster [!UICONTROL PostgresSQL] :
      ...
      1. Plak de **[!UICONTROL ** parameter van de Gastheer **]** van de Vragen van Experience Platform [!UICONTROL Credentials] in het **[!UICONTROL ** de tekstgebied van de Server **]**.
      ...
      1. Plak de **[!UICONTROL ** parameter van het Gegevensbestand **]** {van de Vragen van Experience Platform [!UICONTROL Credentials] in het **[!UICONTROL ** 4} tekstgebied van het Gegevensbestand {.**]**
         ...
         Voeg `%3FFLATTEN` aan de **[!UICONTROL ** 2} parameter van het Gegevensbestand {toe, zodat leest het als **]** bijvoorbeeld. `prod:cja%3FFLATTEN` Zie [ genestelde gegevensstructuren voor gebruik met de hulpmiddelen van derdeBI ](https://experienceleague.adobe.com/en/docs/experience-platform/query/key-concepts/flatten-nested-data) voor meer informatie afvlakken.
