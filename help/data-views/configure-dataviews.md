...
* Attributie-instellingen in Customer Journey Analytics zijn niet-destructief en retroactief. Met andere woorden, u kunt geen onherstelbare schade aan uw datasets in Customer Journey Analytics doen. Zelfs als u per ongeluk iets schrapt, kunt u altijd terug naar [!UICONTROL Experience Platform] gaan en de dataset terug binnen brengen. (Houd er echter rekening mee dat extra kosten ontstaan wanneer de gegevensset weer wordt ingevoerd.)

* Als u een dimensie &quot;gedraagt&quot;als traditionele eVar (omzettingsvariabele) wilt hebben, zou u het met &quot;Last Touch Visit&quot;attributie door gebrek moeten vormen.
...
Het model beschrijft de distributie van omzettingen in de gebeurtenissen in een groep. Bijvoorbeeld, eerste aanraking of laatste aanraking. Bepaalt hoe Customer Journey Analytics krediet voor een succesgebeurtenis toewijst als een variabele meerdere waarden vóór de gebeurtenis ontvangt.
...
Zie [Attribution IQ doc](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/panels/attribution/attribution.html) voor meer informatie.
...
* **Sessie:** kijkt terug naar het begin van de sessie waar een conversie heeft plaatsgevonden. De terugkijkervensters van het bezoek zijn smal, aangezien zij niet voorbij de zitting kijken. De raadplegingsvensters van de zitting respecteren de gewijzigde bezoekdefinitie in gegevensmeningen.
