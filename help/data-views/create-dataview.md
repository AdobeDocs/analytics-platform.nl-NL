...
>abstract="Journey Optimizer moet een gegevensweergave gebruiken die is geconfigureerd met Customer Journey Analytics.<br/> laat deze optie toe om van dit de standaardgegevensmening te maken die in Adobe Journey Optimizer het melden wordt gebruikt."
...
1. Wanneer u uw specifiek schemagebied vond of uw afgeleid gebied bepaalde, sleep dat gebied, zoals ![ pictogram van het Handvat ](https://spectrum.adobe.com/static/icons/workflow_22/Smock_DragHandle_22_N.svg) **[!UICONTROL Page Name]**, van het linkerspoor in de sectie van Metriek of van Dimensionen.
