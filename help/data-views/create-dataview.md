...
description: Leer over alle montages die u kunt vormen wanneer u creeert of een gegevensmening uitgeeft.
...
Zie ![&#x200B; VideoCheckedOut &#x200B;](/help/assets/icons/VideoCheckedOut.svg) [&#x200B; creeer of geef een gegevensmening &#x200B;](https://experienceleague.adobe.com/nl/docs/customer-journey-analytics-learn/tutorials/data-views/overview-of-configuring-data-views-for-cja){target="_blank"} voor een demo video uit.
...
Hiermee geeft u de naam van containers voor de gegevensweergave aan. De namen van de container worden vaak gebruikt in [&#x200B; segmenten &#x200B;](/help/components/segments/seg-overview.md#containers).
...
Selecteer **[!UICONTROL Enable for Data Insights Agent]** om de gegevensmening voor [&#x200B; Data Insights Agent &#x200B;](/help/data-analysis-ai.md) toe te laten. Data Insights Agent is een generatieve AI gespreksagent die van de Medewerker AI in Customer Journey Analytics toegankelijk is. Hiermee kunt u snel gegevens analyseren met tekstaanwijzingen. De agent bouwt relevante visualisaties in Analysis Workspace gebruikend componenten van uw gegevensmening en gebruikend uw daadwerkelijke gegevens.
...
| [!UICONTROL **Jaar waarin de &quot;extra&quot;week voorkomt**] | Met de meeste kalenders van 364 dagen (52 weken van elk 7 dagen), accumuleert elk jaar leftoverdagen tot zij aan een extra week toevoegen. Deze extra week wordt dan toegevoegd aan de laatste maand van dat jaar. Geef op aan welk jaar u de extra week wilt toevoegen.<br><br/>**Extra weken en schrikkeljaren**<br/> wanneer u een douane **[!UICONTROL Calendar type]** (**[!UICONTROL Custom (4‑5‑4)]** selecteert, **[!UICONTROL Custom (4‑4‑5)]**, of **[!UICONTROL Custom (5‑4‑4)]**), accumuleren de resterende dagen elk jaar tot de dagen tot een volledige extra week (7 dagen) toevoegen. Deze extra week wordt toegevoegd aan het jaar dat u selecteert in **[!UICONTROL Year in which the "extra" week occurs]** .<br/><br/> de jaren van de sprong worden opzettelijk niet getoond in **[!UICONTROL Year in which the "extra" week occurs]**. Een schrikkeljaar kan echter nog steeds 53 weken bevatten. Als u wilt dat een schrikkeljaar 53 weken bevat, selecteert u een niet-schrikkeljaar van **[!UICONTROL Year in which the "extra" week occurs]** om ervoor te zorgen dat de cumulatieve datumverschuiving maximaal 7 dagen oplevert voor het doelschrikkeljaar. Als u bijvoorbeeld 53 weken wilt hebben in 2024, selecteert u **[!UICONTROL 2019]** . Van 2019 tot 2024 is de totale datumverschuiving 7 dagen (2020 (+2), 2021 (+1), 2022 (+1), 2023 (+1) en 2024 (+2)), wat resulteert in een 53e week in 20 24.<br/><br/> de selectie voor **[!UICONTROL First day of current year]** beïnvloedt waar de extra week landt. Bevestig uw configuratie met de kalendervoorvertoning. |
...
U kunt segmenten toevoegen die van toepassing zijn op een volledige gegevensweergave. Dit segment wordt toegepast op om het even welk rapport dat u in Workspace loopt. Sleep een segment van de componenten in de linkerspoorstaaf aan het **[!UICONTROL Add segments]** gebied.
