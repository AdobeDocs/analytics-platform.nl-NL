...
## Prime-pakket {#prime-package}

>[!NOTE]
>
>U moet het **Prime** pakket of hoger hebben om de functionaliteit te gebruiken die in deze sectie wordt beschreven. Neem contact op met de beheerder als u niet zeker weet welk Customer Journey Analytics-pakket u hebt.

## Ultimate-pakket {#ultimate-package}

>[!NOTE]
>
>U moet het **Ultimate** pakket hebben om de functionaliteit te gebruiken die in deze sectie wordt beschreven. Neem contact op met de beheerder als u niet zeker weet welk Customer Journey Analytics-pakket u hebt.
...
* **Zitting**: Zoekt file aan het begin van de zitting waar een omzetting gebeurde. De raadplegingsvensters van de zitting respecteren de gewijzigde [&#x200B; onderbreking van de Zitting &#x200B;](/help/data-views/create-dataview.md#session-settings) in een gegevensmening. Wanneer **[!UICONTROL Session]** wordt geselecteerd, wordt het [&#x200B; terugkijkvenster van de Attributie &#x200B;](#atribution-lookback-window) automatisch geplaatst aan **[!UICONTROL Reporting window]** en kan niet worden veranderd.
...
* **&#x200B;**&#x200B;B2B edition [!BADGE &#x200B; van de Kans 1&rbrace; &#x200B;]{type=Informative}: Zoekt naar omzettingen van het werkingsgebied van de opportunitycontainer.
...
Een terugkijkvenster van de attributie is de hoeveelheid tijd een omzetting zou moeten terugkijken om aanraakpunten te omvatten. Als een dimensie-item buiten het terugzoekvenster wordt ingesteld, wordt de waarde niet opgenomen in attributieberekeningen.

* **[!UICONTROL Reporting window]**: hiermee wordt gezocht naar het begin van het rapportagevenster vanaf het moment dat de conversie heeft plaatsgevonden.
...
Afhankelijk van uw rapportagevenster (bijvoorbeeld 10 september - 24 september) ontvangen het toewijzingmodel, de container en de kanalen een ander krediet. Zie onderstaande tabel voor voorbeelden:

| Model | Container | Venster Opzoeken | Toelichting |
|---|---|---|---|
| Eerste aanraking | Sessie | Rapportagevenster | Attributie kijkt alleen naar het derde bezoek. Tussen e-mail en display was e-mail de eerste, dus e-mail krijgt 100% krediet voor de aankoop van $50. |
| Eerste aanraking | Persoon | 30 | Kenmerken bekijken alle drie de bezoeken. De betaalde zoekopdracht was de eerste, dus krijgt deze 100% krediet voor de aankoop van $50. |
| Lineair | Sessie | Rapportagevenster | Krediet wordt verdeeld tussen e-mail en weergave. Beide kanalen krijgen elk $25 krediet. |
| Lineair | Persoon | 30 | Het krediet is verdeeld tussen betaalde onderzoek, sociale, e-mail, en vertoning. Elk kanaal krijgt $12,50 krediet voor deze aankoop. |
| J-vormig | Persoon | 30 | Het krediet is verdeeld tussen betaalde onderzoek, sociale, e-mail, en vertoning.<ul><li>60% krediet wordt gegeven aan vertoning, voor $30.</li><li>20% krediet wordt gegeven voor betaalde zoekopdrachten, voor $10.</li><li>De resterende 20% is verdeeld tussen sociale media en e-mail, wat elk $5 geeft.</li></ul> |
| Tijdverlies | Persoon | 30 | <ul><li>Tussenruimte van nul dagen tussen aanraakpunt weergeven en conversie. `2^(-0/7) = 1`</li><li>Ruimte van nul dagen tussen aanraakpunt en conversie via e-mail. `2^(-0/7) = 1`</li><li>Tussenruimte van zes dagen tussen sociale aanraakpunten en conversie. `2^(-6/7) = 0.552`</li><li>Tussenruimte van negen dagen tussen betaald aanraakpunt en conversie. `2^(-9/7) = 0.41`</li>Het normaliseren van deze waarden resulteert in het volgende:<ul><li>Weergave: 33,8%, krijgt $16,88</li><li>E-mail: 33,8% ontvangt $ 16,88</li><li>Sociaal: 18,6%, $ 9,32</li><li>Betaalde zoekopdracht: 13,8%, krijgt $6,92</li></ul></li></ul> |
...
>[!NOTE]
> 
>Gebruik de informatie op deze pagina wanneer u vragen beantwoordt in de Customer Journey Analytics Upgrade Guide. <br><br> om tot de gids van Customer Journey Analytics toegang te hebben, selecteer het **[!UICONTROL Workspace]** lusje, dan selecteer **[!UICONTROL Upgrade to Customer Journey Analytics]** in het linkerpaneel. Volg de aanwijzingen op het scherm.

## Volgende stap van de controlelijst voor upgrades {#upgrade-note-step}

>[!NOTE]
> 
>Voer de stappen op deze pagina pas uit nadat u alle vorige upgradestappen hebt uitgevoerd. U kunt de aanbevolen upgradestappen volgen (aanbevolen voor de meeste organisaties), of u kunt stappen volgen die dynamisch voor uw organisatie worden gegenereerd met de Customer Journey Analytics Upgrade Guide. <ul><li>**geadviseerde verbeteringsstappen** (geadviseerd voor de meeste organisaties)<p>Een reeks stappen die tot een ideale implementatie van Customer Journey Analytics leiden.</p><p>Voor gedetailleerde informatie, zie [&#x200B; Verbetering van Adobe Analytics aan Customer Journey Analytics &#x200B;](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md).</p></li><li>**de Gids van de Verbetering van Customer Journey Analytics** (de stappen van de Douane die aan de specifieke behoeften van uw organisatie worden aangepast)<p>Er is een nieuwe upgradehandleiding beschikbaar waarmee op dynamische wijze upgradestappen worden gegenereerd die zijn afgestemd op uw organisatie en uw unieke omstandigheden.</p><p>Als u vanuit Customer Journey Analytics toegang wilt tot de hulplijn, selecteert u de tab **[!UICONTROL Workspace]** en vervolgens **[!UICONTROL Upgrade to Customer Journey Analytics]** in het linkerdeelvenster. Volg de aanwijzingen op het scherm.</p></li></ul>
...
## Concept Customer Journey Analytics B2B edition-documentatie {#draft-b2b}
...
| Diepte van gebeurtenis | Hiermee worden opeenvolgende numerieke waarden (1, 2, 3, enz.) toegewezen aan elke gebeurtenisinteractie binnen een sessie. Met deze afmeting kunt u gedetailleerde het volgen en analyse van toelaten waar de specifieke gebeurtenissen in de opeenvolgende stroom van gebruikersinteractie binnen de [&#x200B; begrensde ervaringszitting voorkomen u voor uw gegevensmening &#x200B;](/help/data-views/session-settings.md#session-settings) hebt bepaald. U kunt de voortgang van gebeurtenissen van begin tot eind volgen binnen een begrensde zitting. Als voorbeeld: een bezoeker landt op uw homepage (gebeurtenis 1, start van sessie), gebruikt de zoekfunctie (gebeurtenis 2), bekijkt een pagina met productdetails (gebeurtenis 3), voegt toe aan winkelwagentje (gebeurtenis 4), gaat verder met uitchecken (gebeurtenis 5) en voltooit een aankoop (gebeurtenis 6, einde van sessie). U kunt [!UICONTROL Event depth] nu in een segmentdefinitie gebruiken om gegevens te segmenteren op basis van interactiediepte. |
...
## Op basis van relationeel model {#relational-model-based}

>[!INFO]
>
>In de Customer Journey Analytics-interface kunnen **[!UICONTROL Relational]** -gegevenssets worden gelabeld als **[!UICONTROL Model-based]** .
>